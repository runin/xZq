window.setTitle = function(title) {
    ...
    var $body = $('body');
    var $iframe = $('<iframe style="display:none;" src="./static/photo/default.jpg"></iframe>').on('load', function() {
        setTimeout(function() {
...
window.formatSqlTime = function(str, sepr){
    str = str.replace(/-/g, sepr);
    return str.split(' ')[0];
}
...
window.showTime = function(rT, showTpl){
...
(function(W){function w(d,a,c){var b=0,f=[],h=0,g,e,n,k,m,q,v,p=!1,r=[],t=[],l,u=!1;c=c||{};g=c.encoding||"UTF8";l=c.numRounds||1;n=L(a,g);if(l!==parseInt(l,10)||1>l)throw Error("numRounds must a integer >= 1");if("SHA-1"===d)m=512,q=M,v=X,k=160;else if(q=function(a,c){return N(a,c,d)},v=function(a,c,b,f){var h,C;if("SHA-224"===d||"SHA-256"===d)h=(c+65>>>9<<4)+15,C=16;else if("SHA-384"===d||"SHA-512"===d)h=(c+129>>>10<<5)+31,C=32;else throw Error("Unexpected error in SHA-2 implementation");
...
"undefined"!==typeof exports?"undefined"!==typeof module&&module.exports?module.exports=exports=w:exports=w:W.jsSHA=w})(window);