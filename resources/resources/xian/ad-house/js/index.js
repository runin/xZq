...
(function($) {
	...
	W.callbackFoodEnterHander = function(data) {
		...
		for (var i = 0, len = items.length; i < len; i++) {
			if (items[i].tp === 3) {
                ...
                t._('<div class="page preload " data-uuid="'+ items[i].id +'" data-type="'+ items[i].tp +'"></div>');
            }
		}
	...
	W.callbackCheckLotteryHander = function(data) {
		...
		var img_2600 = 'http://cdn.holdfun.cn/resources/services/house/2600.png',
		 	img_click = 'images/b-click.png';
