                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-立即使用按钮">领&nbsp&nbsp取</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ._('<section class="dialog wxcard-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮">领&nbsp&nbsp取</a>')
                                ._('</section>')
                            ._('</section>')
                            //._('<img class="award-bottom-bg-fake" src="./images/lot-bottom-bg.png">')
                            //._('<img class="award-bottom-bg" src="./images/lot-bottom-bg.png">')
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-none" id="none-dialog">')
                    ...
                    ._('<section class="dialog-content">')
                    ._('<section class="dialog-body">')
                    ._('<img class="award-img-tip" src="./images/thanks.png">')
                    ...
                    ._('</section>')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-none-lottery-award" id="btn-none-lottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(未中奖)-关闭按钮">返&nbsp&nbsp回</a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
