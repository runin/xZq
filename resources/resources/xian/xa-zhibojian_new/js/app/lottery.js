    ...
    H.lottery = {
        ...
        imgMath: function() {//随机背景
            ...
            if(me.lotteryImgList.length >0){
                ...
                $(".yao-bg").css({"background":"url('" + me.lotteryImgList[i] + "') no-repeat center white","background-size":"100% auto"});
            }
        },
        red_record: function(){
        ...
        count_down: function() {
            ...
            $('.detail-countdown').each(function() {
                $(this).countDown({
                    etpl: '<span class="L">%H%</span>' + ':<span class="M">' + '%M%</span>' + ':' + '</span><span class="R">%S%</span>', // 还有...结束
                    stpl: '<span class="L">%H%</span>' + ':<span class="M">' + '%M%</span>' + ':' + '</span><span class="R">%S%</span>', // 还有...开始
                    sdtpl: '',
                    otpl: '',
                    otCallback: function() {
                        if(me.canJump){
