...
var spellLoading = function(className, idName){
    var t = simpleTpl();
    t._('<div class=' + className + '-loading id='+ idName+'>')
        ._('<div class=' + className + '-wrapper>')
            ._('<div class="' + className + '-container container1">')
                ._('<div class="circle1"></div>')
                ._('<div class="circle2"></div>')
                ._('<div class="circle3"></div>')
                ._('<div class="circle4"></div>')
            ._('</div>')
            ._('<div class="' + className + '-container container2">')
                ._('<div class="circle1"></div>')
                ._('<div class="circle2"></div>')
                ._('<div class="circle3"></div>')
                ._('<div class="circle4"></div>')
            ._('</div>')
            ._('<div class="' + className + '-container container3">')
                ._('<div class="circle1"></div>')
                ._('<div class="circle2"></div>')
                ._('<div class="circle3"></div>')
                ._('<div class="circle4"></div>')
...
var showLoading = function() {
	...
	if ($spinner.length > 0) {
       ...
       var t= spellLoading("spinnerb", "spinner");
