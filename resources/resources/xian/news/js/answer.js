...
function loadCurrent(){
    ...
    $('.answer-main').css('minHeight', height - 60);
    if(!isHasCurrent){
        isHasCurrent = true;
        getResult("news/current/" + openid,{
...
function callbackSurveyCurrentHander(data) {
    ...
    activityUuid = data.sinfo.spauid;
    ...
    if (data.code==1) {
        ...
        {   
            ...
            /*单选*/
            $("#current_box").on('click', 'ul li', function(){
...
function submitSurvey() {
    ...
    getResult("news/save?openid=" + openid
