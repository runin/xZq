    ...
    H.dialog = {
        ...
        shiwuLottery: {
            ...
            update: function(data) {
                var me = this;
                if(data.result){
                    $("#shiwu-dialog").find(".award-img").attr("src", "images/shiwu.jpg").attr("onerror", "$(this).addClass(\'none\')");
                    ...
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="btn-lottery-box">')
                                /*._('<p class="award-keyTips">请填写领奖本人姓名和电话<br/>以便本人现场兑奖</p>')*/
                                ...
                                ._('</section>')*/
                                    /*._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-close after" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-close" data-collect-desc="弹层(实物)-继续摇奖按钮">继续摇奖</a>')*/
                            ._('</section>')
                            ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"></a>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
        ...
        linkLottery: {
            ...
            check: function() {
                var me = this, mobile = $.trim($('.phone').val());
                if (!/^\d{11}$/.test(mobile)) {
                    showTips('请填写正确手机号，以便顺利领奖！');
                    return false;
                }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<img class="award-img" src="./images/default-award.png">')
                            ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链奖)-立即使用按钮"></a>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            ...
            wx_card:function(){
                ...
                wx.addCard({
                    ...
                    success: function (res) {
                        ...
                        addUserForMedia('',me.mobile);
                        if(me.cu == 1 && me.isMail){
                            if(localStorage.getItem("prize-mail") != "true" && me.mailText && me.mobile){
                                $.ajax({
                                    type:"GET",
                                    url:"http://221.226.25.2:8080/send_msg/sending",
                                    data:{
                                        "type": "99",//固定值99
                                        "moblie": me.mobile,
                                        "context": me.mailText
                                ...
                                localStorage.setItem("prize-mail","true");
                            }
                        }
                    },
                    fail: function(res){
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="btn-lottery-box">')
                                ._('<section class="input-box none">')
                                    ._('<p class="award-keyTips">请输入你的手机号</p>')
                                    ._('<p><span>电话：</span><input class="phone" type="tel" placeholder=""></p>')
                                ._('</section>')
