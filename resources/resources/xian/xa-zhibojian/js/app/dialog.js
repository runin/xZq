(function($) {
	H.dialog = {
		...
		guide: {
			...
			tpl: function() {
				var t = simpleTpl();
				t._('<section class="modal modal-guide" id="guide-dialog" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-guide-close-btn" data-collect-desc="引导弹层-关闭按钮">')
		...
		rule: {
            ...
            tpl: function() {
                ...
                ._('<div class="dialog rule-dialog">')
                	._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-rule-close-btn" data-collect-desc="规则弹层-关闭按钮"></a>')
                    ._('<div class="content">')
                    	._("<h1>活动规则</h1>")
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					._('<div class="dialog lottery-dialog">')
						._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery-close-btn" data-collect-desc="摇一摇抽奖弹层-关闭按钮"></a>')
						...
						._('</div>')
						._('<a href="#" class="btn btn-ok" id="btn-ok" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery-btn-ok" data-collect-desc="摇一摇抽奖弹层-点击确定领奖按钮">领取</a>')
						._('<a href="#" class="btn btn-back" id="btn-back" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery-btn-back" data-collect-desc="摇一摇抽奖弹层-点击继续加油按钮">继续加油</a>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery4vote-dialog">')
					._('<div class="dialog lottery4vote-dialog">')
						._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery4vote-close-btn" data-collect-desc="答题抽奖弹层-关闭按钮"></a>')
						._('<p class="award-tips"></p>')
						._('<p class="award-no-tips">大奖与你擦肩而过<br>继续加油哦~</p>')
						._('<div class="award-box">')
							._('<img class="award-img">')
						...
						._('</div>')
						._('<a href="#" class="btn btn-vote4ok" id="btn-vote4ok" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery4vote-btn-ok" data-collect-desc="答题抽奖弹层-点击确定领奖按钮">领取</a>')
						._('<a href="#" class="btn btn-vote4back" id="btn-vote4back" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-lottery4vote-btn-back" data-collect-desc="答题抽奖弹层-点击继续加油按钮">继续加油</a>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
			...
			tpl: function() {
				...
				t._('<section class="modal" id="voteWrong-dialog">')
					._('<div class="dialog voteWrong-dialog">')
						._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-voteWrong-close-btn" data-collect-desc="答错弹层-关闭按钮"></a>')
						._('<p class="award-no-tips">不好意思，答错了<br>继续加油哦~</p>')
						._('<div class="award-box">')
							._('<img class="award-no-img" src="./images/bg-no-right.png">')
						._('</div>')
						._('<a href="#" class="btn btn-voteWrongback" id="btn-voteWrongback" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-voteWrong-btn-back" data-collect-desc="答错弹层-点击继续加油按钮">继续加油</a>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
			...
			tpl: function() {
				...
				t._('<section class="modal" id="fudai-dialog">')
					._('<div class="dialog fudai-dialog">')
						._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-fudai-close-btn" data-collect-desc="答对弹层-关闭按钮"></a>')
						._('<p class="award-no-tips">回答正确<br>下面开始抽奖</p>')
						._('<div class="award-box">')
						._('</div>')
						._('<a href="#" class="btn btn-fudaiback" id="btn-fudaiback" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-fudai-btn-back" data-collect-desc="答对弹层-点击好的按钮">好的</a>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
