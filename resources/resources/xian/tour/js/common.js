...
var share = function(backUrl) {
	...
	if ($share_box.length == 0) {
		t._('<div class="share_box" id="share_box">')
	...
	$('body').append($share_box).delegate('.back_btn', 'click', function(e) {
		e.preventDefault();
		e.stopPropagation();
	...
	}).delegate('.refresh_btn', 'click', function(e) {
		e.preventDefault();
		location.reload();
	}).delegate('.share_box', 'click', function(e) {
		$share_box.hide();
	});
