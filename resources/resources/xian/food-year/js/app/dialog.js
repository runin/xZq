	...
	H.dialog = {
		...
		rule: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="food-annual-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
					._('<div class="dialog rule-dialog">')
						._('<h2></h2>')
						._('<div class="content border none">')
							._('<div class="rule"></div>')
						._('</div>')
						._('<p class="dialog-copyright">本活动最终解释权归《乐在西安》栏目所有</p>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
		...
		lottery: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					...
					._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="food-annual-lottdialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
						//未中奖
						._('<div class="not-lott " id="not-lott">')
							._('<img src="images/open-li.png">')
							._('<h1>很遗憾，没抽中哦，再接再厉吧</h1>')
							._('<a href="javascript:share();" class="btn btn-share" data-collect="true" data-collect-flag="food-annual-sharebtn" data-collect-desc="分享按钮">邀请小伙伴来抽奖</a>')
							._('<p class="da-tips"><a href="#" class="btn-record" data-collect="true" data-collect-flag="food-annual-rank" data-collect-desc="年度美食-查看中奖记录">查看中奖记录</a></p>')
						...
						._('<div class="lott none" id="lott">')
							...
							._('<a class="btn btn-share bth-aw btn-award" id="btn-award" data-collect="true" data-collect-flag="food-annual-combtn" data-collect-desc="年度美食-确定按钮">确定</a>')
							._('<p class="da-tips"><a href="#" class="btn-record" data-collect="true" data-collect-flag="food-annual-rank" data-collect-desc="年度美食-查看中奖记录">查看中奖记录</a></p>')
						._('</div>')
						._('<p class="dialog-copyright">本活动最终解释权归《乐在西安》栏目所有</p>')
					._('</div>')
		...
		record: {
			...
			tpl: function() {
				var t = simpleTpl();
				t._('<section class="modal" id="rule-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="food-annual-recoddialog-closebtn" data-collect-desc="中奖记录弹层-关闭按钮"></a>')
					._('<div class="dialog rule-dialog">')
