		...
		rule: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					...
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
		...
		prize: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-rul " id="rule-dialog">')
					...
					._('</div>')
					._('</div>')
					._('<a class="get-btn" data-collect="true" data-collect-flag="tv-xian-zhibojian-redpack-btn" data-collect-desc="领取红包">')
					._('打开')
					._('</a>')
					._('</div>')
					...
					._('<a href="#" class="btn btn-award" id="btn-justclose" data-collect="true" data-collect-flag="tv-xian-zhibojian-lotterydialog-closebtn" data-collect-desc="抽奖弹层-抽奖确认按钮"></a>')
					._('<div class="tip"></div>')
					._('<img class="zanzhu" src="">')
					...
					._('<a href="#" class="btn btn-award" id="btn-award" data-collect="true" data-collect-flag="tv-xian-zhibojian-lotterydialog-combtn" data-collect-desc="抽奖弹层-抽奖确认按钮">确认</a>')
					._('</div>')
					...
					._('<a href="#" class="btn btn-award" id="btn-close" data-collect="true" data-collect-flag="tv-xian-zhibojian-lotterydialog-closebtn" data-collect-desc="抽奖弹层-抽奖确认按钮">返回</a>')
					._('</div>')
					._('<div class="conc none">')
					._('<a href="#" class="outer none" data-collect="true" data-collect-flag="tttj" data-collect-desc="天天淘金"></a>')
					._('<a href="#" class="btn btn-award" id="btn-back" data-collect="true" data-collect-flag="tv-xian-zhibojian-lotterydialog-closebtn" data-collect-desc="抽奖弹层-抽奖确认按钮">领取</a>')
					._('</div>')
					._('</div>')
					...
					._('<a class="close-btn close" data-collect="true" data-collect-flag="tv-xian-zhibojian-dialog-close-btn" data-collect-desc="关闭谈层">确定</a>')
					._('</div>')
					._('</div>')
					._('</div>')
					._('</section>');
		...
		confirm: {
			...
			tpl: function(data) {
				...
				t._('<section class="modal" id="confirm-dialog">')
					...
					._('<a href="#" class="btn-confirm" data-collect="true" data-collect-flag="tv-xian-zhibojian-conformdialog-closebtn" data-collect-desc="广告弹层-关闭按钮"></a>')
					._('<img src="'+data+'">')
					._('</div>')
					._('</section>');
