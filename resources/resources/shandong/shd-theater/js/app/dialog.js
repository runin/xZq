    ...
    H.dialog = {
        ...
        redbagLottery: {
            ...
            event: function() {
                ...
                $("#btn-redbagLottery-close").click(function(e){
                    e.preventDefault();
                    e.stopPropagation();
                    me.close();
                });
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-more" id="btn-redbagLottery-close" data-collect="true" data-collect-flag="dialog-redbagLottery-btn-close" data-collect-desc="弹层(红包)-再摇一次按钮"></a>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbagLottery-btn-use" data-collect-desc="弹层(红包)-立即使用按钮"></a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
        ...
        shiwuLottery: {
            ...
            check: function() {
                ...
                else if (addr.length < 9 || addr.length > 50) {
                    showTips('地址长度为9~50个字符');
                    $addr.focus();
                    return false;
                }
                return true;
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-more" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="dialog-shiwuLottery-btn-close" data-collect-desc="弹层(实物)-再摇一次按钮"></a>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwuLottery-btn-award" data-collect-desc="弹层(实物)-领取按钮"></a>')
                                ._('</section>')
                            ._('</section>')
        ...
        llLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('<p><input type="tel" class="mobile" placeholder="电话" /></p>')
                    //._('<p><input type="text" class="address" placeholder="地址" /></p>')
                    ._('<a href="javascript:void(0);" class="btn-more" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="dialog-llttery-btn-close" data-collect-desc="弹层(流量红包)-再摇一次按钮"></a>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-llttery-btn-award" data-collect-desc="弹层(流量红包)-领取按钮"></a>')
                    ._('</section>')
                    ._('</section>')
                    //._('<img class="award-bottom-bg-fake" src="./images/lot-bottom-bg.png">')
                    //._('<img class="award-bottom-bg" src="./images/lot-bottom-bg.png">')
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-more" id="btn-linkLottery-close" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-close" data-collect-desc="弹层(外链)-再摇一次按钮"></a>')
        ...
        codeLottery: {
            ...
            event: function() {
                ...
                this.$dialog.find('#btn-codeLottery-close').click(function(e) {
                    e.preventDefault();
                    me.close();
                });
            },
                ...
                t._('<section class="modal modal-code" id="code-dialog">')
                    ._('<section class="dialog code-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-more" id="btn-codeLottery-close" data-collect="true" data-collect-flag="dialog-jifen-btn-codeLottery-close" data-collect-desc="弹层(兑换码)-再摇一次按钮"></a>')
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-jifen" id="jifen-dialog">')
                    ...
                    ._('</section>')
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-more btn-jifen-lottery-award" id="btn-jifenLottery-close" data-collect="true" data-collect-flag="dialog-jifen-btn-jifenLottery-close" data-collect-desc="弹层(积分)-再摇一次按钮"></a>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-jifen-lottery-award" id="btn-jifenLottery-award" data-collect="true" data-collect-flag="dialog-jifen-btn-jifenLottery-award" data-collect-desc="弹层(积分)-领取按钮"></a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
        ...
        wxcardLottery: {
            ...
            event: function() {
                ...
                $('#btn-wxcardLottery-close').click(function(e) {
                    e.preventDefault();
                    H.lottery.isCanShake = true;
                    H.lottery.canJump = true;
                    me.close();
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ._('<section class="dialog wxcard-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-more btn-wxcard-lottery-award" id="btn-wxcardLottery-close" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-close" data-collect-desc="弹层(卡券)-再摇一次按钮"></a>')
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-none" id="none-dialog">')
                    ...
                    ._('<p class="award-keyTips">关注山东卫视，赢取更多奖品</p>')
                    ._('</section>')
                    ._('<section class="dialog-footer">')
            ...
            event: function(data) {
                ...
                this.$dialog.find('#btn-openLuckLottery-close').click(function(e) {
                    ...
                    if(data == null || data.result == false || data.pt == 0){
                        ...
                        } else if ((data.pt == 9) && (data.pd="游戏") && is_android()) {
