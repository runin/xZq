	...
	H.dialog = {
		...
		rule: {
			...
			open: function() {
                ...
                if(this.ruleData){
                    ...
                    getResult({
                        url: 'api/common/rule',
                        loading: true,
                        jsonpCallback: 'commonApiRuleHandler',
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    ...
                    'top': Math.round((height-343)/2)+'px'
                });
        ...
        kjLottery: {
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    ...
                    'top': Math.round((height-240)/2)+'px'
                });
            },
            close: function () {
                var me = this;
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="lottery-dialog">')
                    ._('<div class="dialog lottery-dialog">')
                        ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="life-yao-lotterydialog-closebtn" data-collect-desc="卡劵抽奖弹层-关闭按钮"></a>')
                        ._('<div class="dialog-inner">')
                            ._('<div class="award-win none">')
                                ._('<h2 class="tt"></h2>')
                                ._('<img class="pi" src="" />')
                                ._('<img class="wai" src="images/red-wai.png" />')
                                ._('<div class="contact">')
                                    ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="life-yao-lotterydialog-combtn" data-collect-desc="卡劵抽奖弹层-抽奖确认按钮">立即领取</a>')
                                ._('</div>')
                                ._('<img class="bottom" src="images/red-bottom.png" />')
                            ._('</div>')
                        ._('</div>')
                    ._('</div>')
                ._('</section>');
        ...
        swLottery: {
            ...
            tpl: function() {
                var t = simpleTpl();
                t._('<section class="modal" id="lottery-dialog">')
                    ._('<div class="dialog lottery-dialog sw-dialog">')
                            ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="life-yao-swdialog-closebtn" data-collect-desc="实物抽奖弹层-关闭按钮"></a>')
                            ._('<div class="award-win none">')
                                ._('<h2 class="tt"></h2>')
                                ._('<img class="pi" src="" />')
                                ._('<img class="wai" src="images/red-wai.png" />')
                                ._('<div class="contact">')
                                    ._('<h4 class="award-tip">请您填写您的真实信息以便领奖</h4>')
                                    ._('<p><input type="text" class="name" placeholder="姓名"/></p>')
                                    ._('<p><input type="tel" class="mobile" placeholder="电话"/></p>')
                                    ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="life-yao-swdialog-combtn" data-collect-desc="实物抽奖弹层-抽奖确认按钮">立即领取</a>')
                                    ._('<a href="#" class="btn btn-share btn-qd" data-collect="true" data-collect-flag="life-yao-swdialog-back-btn" data-collect-desc="实物抽奖弹层-返回按钮">返 回</a>')
                                ._('</div>')
                                ._('<img class="bottom" src="images/red-bottom.png" />')
                            ._('</div>')
                    ._('</div>')
        ...
        redLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="red-dialog">')
                    ._('<div class="dialog lottery-dialog">')
                    ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="life-yao-reddialog-closebtn" data-collect-desc="红包抽奖弹层-关闭按钮"></a>')
                        ._('<div class="award-win none">')
                            ._('<h2 class="tt"></h2>')
                            ._('<img class="pi" src="" />')
                            ._('<img class="wai" src="images/red-wai.png" />')
                            ._('<div class="contact">')
                                ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="life-yao-lotterydialog-combtn" data-collect-desc="红包抽奖弹层-领取按钮">立即领取</a>')
                            ._('</div>')
                            ._('<img class="bottom" src="images/red-bottom.png" />')
                        ._('</div>')
                    ._('</div>')
                                ...
                                ._('<div class="back">')
                                    ...
                                    ._('<div class="award-win none">')
                                        ...
                                        ._('<div class="contact">')
                                            ...
                                            ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="yao-jfdialog-combtn" data-collect-desc="积分抽奖弹层-提交按钮">提 交</a>')
                                            ._('<a href="#" class="btn btn-share btn-qd" data-collect="true" data-collect-flag="yao-jfdialog-qd-btn" data-collect-desc="积分抽奖弹层-打开关注二维码按钮">确定</a>')
                                        ._('</div>')
        ...
        wlLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="red-dialog">')
                    ._('<div class="dialog lottery-dialog">')
                        ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="life-yao-wldialog-closebtn" data-collect-desc="外链抽奖弹层-关闭按钮"></a>')
                        ._('<div class="award-win none">')
                            ._('<h2 class="tt"></h2>')
                            ._('<img class="pi" src="" />')
                            ._('<img class="wai" src="images/red-wai.png" />')
                            ._('<div class="contact">')
                                ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-life="gzj-yao-wldialog-combtn" data-collect-desc="外链抽奖弹层-抽奖确认按钮">立即领取</a>')
                            ._('</div>')
                            ._('<img class="bottom" src="images/red-bottom.png" />')
                        ._('</div>')
                    ._('</div>')
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<div class="dialog thanks-dialog">')
                        ._('<a href="#" class="btn-close animated" data-collect="true" data-collect-flag="gzj-yao-thanks-closebtn" data-collect-desc="谢谢参与弹层-关闭按钮"></a>')
                        ._('<img class="thanks-top" src="images/thanks-top.png">')
                        ._('<img class="thanks-img" src="images/thanks.jpg">')
                        ._('<a href="#" class="btn btn-qd" data-collect="true" data-collect-flag="gzj-yao-thanks-btn-award" data-collect-desc="谢谢参与弹层-返回按钮">返 回</a>')
                    ._('</div>')
                ._('</section>');
                return t.toString();
            },
            update: function(data) {
                if(data && data.pi){
                    $('.thanks-dialog img').attr('src',data.pi || "./images/thanks.jpg");
                }
            }
        },
        // 积分排行榜
        rank: {
            ...
            open: function() {
                ...
                getResult({
                    url: 'api/lottery/integral/rank/self',
                    data: {
                        oi: openid,
                        pu: H.dialog.uid
                    },
                    loading: true,
                    jsonpCallback: 'callbackIntegralRankSelfRoundHandler',
                    success : function(data) {
                        if (data.result) {
            ...
            selfupdate: function(data) {
                ...
                getResult({
                    url: 'api/lottery/integral/rank/top10',
                    data: {
                        pu: H.dialog.uid
                    },
                    loading: true,
                    jsonpCallback: 'callbackIntegralRankTop10RoundHandler',
                    success : function(data) {
                        if (data.result) {
