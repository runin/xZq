                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-use" id="btn-redbag-use" data-collect="true" data-collect-flag="dialog-redbag-btn-use" data-collect-desc="弹层(红包)-点我领取按钮">马上领取</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
        ...
        shiwuLottery: {
                    ...
                    if(me.check()){
                        if(!$('#btn-shiwuLottery-award').hasClass("flag")){
                            ...
                            var mobile = $.trim(me.$dialog.find('.mobile').val()),
                                ...
                                idno = $.trim(me.$dialog.find('.idno').val()),
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    if(data.pt == 1 && data.cu == 1){
                        $(".idno").parent().removeClass("none");
                    }
                }
            },
            check: function() {
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ...
                                    ._('<p class="none"><input type="text" class="idno" placeholder="身份证号" /></p>')
