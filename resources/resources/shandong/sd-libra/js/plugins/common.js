...
var recordUserLog = function(openid, operateDesc, operateDomId,flag) {
	$.ajax({
		type : "get",
		async : true,
 ...
 * @param operateDomId 操作的元素的id
 */
var recordUserPage = function(openid, operateDesc, operateDomId) {
	recordUserLog(openid, operateDesc, operateDomId, "true");
};
