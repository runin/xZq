        ...
        current_lottery: {
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    'width': "258px",
                    'height': "206px",
                    'left': Math.round((width-258)/2)+'px',
                    'top': Math.round((height-206)/2)+'px'
                });
            },
            close: function () {
                var me = this;
            ...
            event: function () {
                ...
                this.$dialog.find('#go-yao').click(function (e) {
                    e.preventDefault();
                    H.dialog.btn_animate($(this));
                    toUrl('lottery.html');
                });
            ...
            tpl: function () {
                ...
                t._('<section class="modal modal-rule" id="rule-dialog">')
                    ._('<div class="dialog current-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            ._('<img src="images/current-tlt.png" />')
                            ._('<h2>摇奖已开启，快去摇奖吧~</h2>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="#" class="btn-lottery" id="close" data-collect="true" data-collect-flag="dialog-current-lottery-liu" data-collect-desc="弹层(红包)-留在此页按钮">留在此页</a>')
                                ._('<a href="#" class="btn-lottery" id="go-yao" data-collect="true" data-collect-flag="dialog-current-lottery-use" data-collect-desc="弹层(红包)-立即摇奖按钮">立即摇奖</a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</div>')
                ._('</section>');
        ...
        rule: {
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    ...
                    'height': "354px",
                    'left': Math.round((width-258)/2)+'px',
                    'top': Math.round((height-354)/2)+'px'
                });
            },
            close: function () {
                var me = this;
        ...
        knowledge: {
            ...
            update: function(type){
                ...
                if (!me.localData) {
                    ...
                    hidenewLoading();
                    me.change_value(type, me.localData);
                }
            },
            change_value: function(type, data){
                var me = this,
                    $ruleContent = $("#rule-content");
                switch(type){
                    case "zhi":
                        $ruleContent.html(data.gitems[0].info);
                        break;
                    case "shi":
                        $ruleContent.html(data.gitems[1].info);
                        break;
                    case "ku":
                        $ruleContent.html(data.gitems[2].info);
                        break;;
            ...
            tpl: function () {
                ...
                t._('<section class="modal modal-rule" id="rule-dialog">')
                    ._('<div class="dialog rule-dialog">')
                        /*._('<a href="#" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-rule-btn-close" data-collect-desc="弹层(活动规则)-关闭按钮"></a>')*/
                        ._('<div class="dialog-content">')
                            ._('<div class="rule-content knowledge-content" id="rule-content"></div>')
                        ._('<a href="#" class="btn-knowledge-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-rule-btn-close" data-collect-desc="弹层(活动规则)-关闭按钮">关闭</a>')
                        ._('</div>')
                    ._('</div>')
                ._('</section>');
                return t.toString();
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<img src="images/win-prize.png" />')
                            /*._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                            ._('<p class="award-keyTips"></p>')*/
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
