	...
	H.dialog = {
			...
			tpl: function() {
				...
				t._('<section class="modal modal-guide" id="guide-dialog">')
					._('<div class="dialog guide-dialog relocated">')
						._('<div class="guide-title"><img src="./images/guide-title.png"></div>')
						._('<div class="guide-content"><p>1.打开电视，锁定沈阳电视台</p>')
						._('<p>2.打开微信，进入摇一摇(电视)</p>')
						._('<p>3.对着电视摇一摇，赢取奖品</p>')
						._('<a href="#" class="btn btn-try" data-collect="true" data-collect-flag="sy-tvshow-guide-trybtn" data-collect-desc="引导弹层-关闭按钮">等下就去试试</a></div>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
		...
		rule: {
			...
			open: function() {
				...
				$('#rule-dialog .btn-close').css('top', ruleTop + 5);
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
		...
		rank: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rank-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-rankdialog-closebtn" data-collect-desc="积分排行榜弹层-关闭按钮"></a>')
		...
		fudai: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="fudai-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-rankdialog-closebtn" data-collect-desc="领奖弹层-关闭按钮"></a>')
					._('<div class="fudai" data-collect="true" data-collect-flag="sy-tvshow-rankdialog-clickbtn" data-collect-desc="领奖弹层-点击按钮"><p>恭喜您，获得红包一个</p><div class="fudai-round"></div><i>马上打开</i></div>')
				._('</section>');
				return t.toString();
			}
		},
		lottery: {
				...
				if (data != null && data != '') {
					if (data.result) {
						if (data.pt === 1) { //实物奖品
							...
							this.$dialog.find('img').attr('src', (data.pi || ''));
							this.$dialog.addClass(this.LOTTERIED_CLS);
                    	 	recordUserPage(openid, "《沈阳剧场》红包领奖页", '');
							this.$dialog.find('.award-win').removeClass('none');
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-lotterydialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
								...
								._('<div class="back">')
									._('<div class="award-win none">')
										...
										._('<div class="contact">')
											...
											._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="sy-tvshow-lotterydialog-OKbtn" data-collect-desc="抽奖弹层-确定按钮">确定</a>')
											._('<a href="#" class="btn btn-red" data-collect="true" data-collect-flag="sy-tvshow-lotterydialog-redbtn" data-collect-desc="抽奖弹层-领取现金按钮">领取现金</a>')
									...
									._('<div class="award-none none">')
										...
										._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-lotterydialog-backbtn" data-collect-desc="抽奖弹层-返回按钮">返回答题</a>')
									._('</div>')
								._('</div>')
							._('</div>')
						._('</div>')
		...
		success: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="success-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="sy-tvshow-successdialog-closebtn" data-collect-desc="领奖成功弹层-关闭按钮"></a>')
					._('<div class="success" data-collect="true" data-collect-flag="sy-tvshow-successdialog-clickbtn" data-collect-desc="领奖成功弹层-点击按钮"><div class="success-round"></div><p>领取成功</p><i>关注微店公众号</i></div>')
