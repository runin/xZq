    ...
    H.dialog = {
        ...
        thanks: {
            ...
            pre_dom: function(){
                var width = $(window).width(),
                    ...
                    $(".thanks-dialog").css({
                        ...
                        'height': "250px",
                        'left': Math.round((width-250)/2)+'px',
                        'top': Math.round((height-250)/2)+'px'
                    });
            },
            close: function() {
                var me = this;
            ...
            event: function() {
                ...
                this.$dialog.find('.continue-btn').click(function(e) {
                    e.preventDefault();
                    H.dialog.btn_animate($(this));
                    me.close();
                });
        ...
        fail: {
            ...
            tpl: function() {
                var t = simpleTpl(),me = this;
                t._('<section class="modal modal-thanks" id="fail-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-thanks-btn-close" data-collect-desc="弹层(谢谢参与)-关闭按钮"></a>')
                        ._('<fieldset class="dialog-content">')
                            ._('<h1>很遗憾竞猜失败</h1>')
                            ._('<img class="icon-sorry" src="images/icon-fail.png">')
                            ._('<h2>没关系，还有机会哦~</h2>')
                        ._('</fieldset>')
                    ._('</section>')
                    ._('</section>');
