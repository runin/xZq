        ...
        codeLottery: {
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    if (data.cc || data.cc != '') {
                        if (data.cc.split(',')[0]) {
                            $("#code-dialog").find(".code-box").append("<p class='award-code'>兑奖码：" + (data.cc.split(',')[0] || '') + "</p>");
                        }
                        if (data.cc.split(',')[1]) {
                            $("#code-dialog").find(".code-box").append("<p class='award-code'>兑奖码：" + (data.cc.split(',')[1] || '') + "</p>");
                        }
                ...
                t._('<section class="modal modal-code" id="code-dialog">')
                    ._('<section class="dialog code-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ._('<img class="award-img" src="./images/default-award.png">')
                                ._('<section class="code-box none"><p class="award-keyTips"></p></section>')
                            ._('</section>')
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-none" id="none-dialog">')
                    ...
                    ._('<section class="dialog-content">')
                    ._('<section class="dialog-body">')
                    ._('<img class="award-img-tip" src="./images/thanks-tips.png">')
                    ._('<img class="award-img-bg" src="./images/thanks-bg.jpg">')
                    ._('<p class="award-keyTips">关注这里，让更多奖品爱上你</p>')
                    ._('</section>')
                    ._('<section class="dialog-footer">')
