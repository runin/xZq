...
(function($) {
	...
	W.shakeOccur = function(){
		...
		var borderWidth = H.yao.$bg.find('.cover-wrapper').attr('yao-border-width');
		var borderColor = H.yao.$bg.find('.cover-wrapper').attr('yao-border-color');
