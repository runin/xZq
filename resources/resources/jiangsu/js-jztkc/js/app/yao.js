    ...
    H.lottery = {
        ...
        imgMath: function() {//随机背景
            ...
            if(me.lotteryImgList.length >0){
                ...
                $(".yao-bg").css({"background":"url('" + me.lotteryImgList[i] + "') no-repeat center center","background-size":"100% auto"});
            }
        },
        red_record: function(){
        ...
        currentPrizeAct:function(data){
            //获取抽奖活动
            var me = this, nowTimeStr = this.nowTime, prizeLength = 0, prizeActList = data.la;
            me.pal = prizeActList;
