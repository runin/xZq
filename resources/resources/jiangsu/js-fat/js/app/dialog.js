    ...
    H.dialog = {
        ...
        rule: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-rule" id="rule-dialog">')
                    ...
                    ._('<a href="#" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-rule-btn-close" data-collect-desc="弹层(活动规则)-关闭按钮"><img src="images/btn-close.png"></a>')
        ...
        redbagLottery: {
            ...
            pre_dom: function() {
                ...
                if (W.screen.width === 320) {
                    ...
                    $(".dialog").css({
                        ...
                        'top': Math.round((height - 520) / 2) + 'px'
                    });
                }
            },
            close: function() {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<img src="images/prize-tip.png" class="icon-congrats">')
            ...
            pre_dom: function() {
                ...
                if (W.screen.width === 320) {
                    $(".dialog").css({
                        ...
                        'height': "370px",
                        'left': Math.round((width - 270) / 2) + 'px',
                        'top': Math.round((height - 370) / 2) + 'px'
                    });
                } else {
                    $(".dialog").css({
                        'width': "312px",
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        // ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-link-btn-close" data-collect-desc="弹层(外链)-关闭按钮"><img src="images/btn-close.png"></a>')
                        ._('<section class="dialog-content">')
                            ._('<img src="images/prize-tip.png" class="icon-congrats">')
                            ._('<div class="award-img">')
        ...
        thanks: {
            ...
            pre_dom: function() {
                ...
                if (W.screen.width === 320) {
                    $(".dialog").css({
                        ...
                        'height': "290px",
                        'left': Math.round((width - 230) / 2) + 'px',
                        'top': Math.round((height - 290) / 2) + 'px'
                    });
                } else {
                    $(".dialog").css({
                        'width': "312px",
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-thanks-btn-close" data-collect-desc="弹层(谢谢参与)-关闭按钮"><img src="images/btn-close.png"></a>')
                    ._('<section class="dialog-content">')
                    ._('<img src="images/thanks-tip.png" class="icon-congrats">')
        ...
        sign: {
            ...
            tpl: function() {
                var t = simpleTpl(),
                    me = this;
                t._('<section class="modal modal-thanks" id="sign-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-thanks-btn-close" data-collect-desc="弹层(谢谢参与)-关闭按钮"><img src="images/btn-close.png"></a>')
                    ._('<section class="dialog-content">')
                        ._('<img class="icon-thanks" src="images/code.jpg">')
                        ._('<h3 class="tlt">长按二维码关注公众号<br/>关注官方微信，立即报名</h3>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
