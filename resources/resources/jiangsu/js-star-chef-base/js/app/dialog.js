            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'top': Math.round((height-410)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "320px",
                        ...
                        'top': Math.round((height-510)/2)+'px'
                    });
                }
            },
            close: function() {
           ...
           /* address: '',*/
                    ...
                    if(me.check(data)) {
                        if(!$(this).hasClass("flag")){
                            ...
                            getResult('api/lottery/award', {
                                ...
                                em: me.mail ? encodeURIComponent(me.mail) : "",
                                ic: me.card ? encodeURIComponent(me.card) : ""
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    if(data.ru == "collectionAddress"){
                        $("#shiwu-dialog").find(".address").val(data.ad ? data.ad : '').removeClass("none");
                    }else{
                        $("#shiwu-dialog").find(".mail").val(data.em ? decodeURIComponent(data.em) : '').removeClass("none");
                        $("#shiwu-dialog").find(".card").val('').removeClass("none");
                    }
                }
            },
            check: function(data) {
                        ...
                        ._('<fieldset class="dialog-content">')
                            ...
                            ._('<section class="footer">')
                                ._('<section class="input-box">')
                                    ...
                                    ._('<p><input class="mail none" type="text" id="mail" placeholder="邮箱"></p>')
                                    ._('<p><input class="card none" type="text" id="card" placeholder="身份证"></p>')
        ...
        wxcardLottery: {
            ...
            wx_card:function(){
                ...
                wx.addCard({
                    cardList: [{
                        cardId: me.ci,
                        cardExt: "{\"timestamp\":\""+ me.ts +"\",\"signature\":\""+ me.si +"\",\"outer_id\":\"10007\"}"
                    }],
        ...
        thanks: {
            ...
            textMath: function() {//随机img
               ...
               /* if(this.index == 2){
                ...
                me.randomSrc = thanks_imgsSmall[0];
                recordUserOperate(openid, "澳门巴黎人二维码", "blr");
            ...
            tpl: function() {
                ...
                var classHide = (this.index == 2 ?  "" : "none");console.log(this.index);
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ...
                        ._('<fieldset class="dialog-content">')
                            ...
                            ._('<img class="icon-thanks" style="width: 66%;" src="'+ me.randomSrc +'">')
