            ...
            init: function (systemTime, timeDiff) {//主函数
                ...
                function downFn() {
                    try {
                        for (var i = countIndex, len = p.timeArr.length; i < len; i++) {
                            ...
                            if (t < st) {
                                (function () {
                                    ...
                                    $(that).html(tmp);
                                    p.countDownFn && p.countDownFn(that, tmp, p.timeArr[i].index);
                                } ());
                                break;
                            }
                            if (st < t && t < et) {
                            ...
                            if (t > et) {
                                ...
                                (function () {
                                    if (countIndex == p.timeArr.length) {
                                        ...
                                        if (p.endFn) { p.endFn(that, p.timeArr[i].index,o,t); }
                                    }
                                } ());
                                break;
                            };
                        ...
                        clearInterval(window[p.id]);
                    }
                };
                downFn();
                window[p.id] = setInterval(downFn, p.timeInterval);
            },
            sort: function () {//排序函数
