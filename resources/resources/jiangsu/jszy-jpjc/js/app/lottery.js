(function($) {
    H.lottery = {
        ...
        initComponent: function(){
            var me = this,
            recordDelay = Math.ceil(4000*Math.random()),
            allRecordTime = Math.ceil(20000*Math.random() + 300000),
        ...
        if(data.result){
            ...
            if(list && list.length > 0){
                ...
                for(var i = 0 ; i < list.length; i++){
                    ...
                    con += "<li><div class='con'><img src='images/gift.png' /><span>" + username + "中了 <label>" + list[i].pn + "</label></label></span></div></li>";
                }
