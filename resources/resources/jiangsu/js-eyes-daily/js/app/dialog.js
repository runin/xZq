		...
		rule: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-rul" id="rule-dialog">')
					._('<a href="#" class="btn-close close" data-collect="true" data-collect-flag="js-eyes-daily-rule-dialog-close-btn" data-collect-desc="新闻眼日常版规则弹层-关闭按钮"></a>')
					._('<div class="dialog rule-dialog">')
					._('<h2>活动规则</h2>')
					._('<div class="content">')
					._('<div class="rule-con"></div>')
					._('</div>')
					._('<p class="dialog-copyright"><span class="btn my-zhidao close" data-collect="true" data-collect-flag="js-eyes-daily-know-btn" data-collect-desc="新闻眼日常版规则弹层-我知道了按钮">我知道了</span>更多信息请关注公众号“江苏新闻”</p>')
					._('</div>')
					._('</section>');
				return t.toString();
			}
...
//					}
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					...
					._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="js-eyes-daily-lott-dialog-close-btn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
						...
						._('<div class="not-lott none" id="not-lott">')
							...
							._('<h1>别灰心</h1>')
							._('<h2>观看江苏卫视18:00《新闻眼》，继续摇一摇，还有机会抽奖哦！</h2>')
							._('<span class="btn back" data-collect="true" data-collect-flag="js-eyes-daily-share-btn" data-collect-desc="返回按钮">返 回</span>')
						._('</div>')
						//中奖
						._('<div class="lott none" id="lott">')
							...
							._('<a class="btn" id="btn-award" data-collect="true" data-collect-flag="js-eyes-daily-combtn" data-collect-desc="新闻眼日常版-确定按钮">确定</a>')
							._('<div class="da-tips none">')
								._('<p>邀请朋友一起抽奖</p>')
								._('<span class="btn back" data-collect="true" data-collect-flag="js-eyes-daily-back" data-collect-desc="新闻眼日常版-返回按钮">返回</span>')
							._('</div>')
						._('</div>')
						._('<p class="dialog-copyright">更多信息请关注公众号“江苏新闻”</p>')
					._('</div>')
					._('</section>');
				return t.toString();
			},
			update: function(data) {
					if(data&&data.pt != 2 && data.code == 0){
			...
			tpl: function () {
				...
				if(!H.dialog.over.maxCount){
					...
					._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="js-eyes-daily-lottdialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
						...
						._('</div>')
						._('<p class="dialog-copyright"><span class="btn lottery-close" data-collect="true" data-collect-flag="js-eyes-daily-sharebtn" data-collect-desc="返回按钮">我知道啦</span><br />更多信息请关注公众号“江苏新闻”</p>')
					._('</div>')
					._('</section>');
					return t.toString();
				}
				...
				._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="js-eyes-daily-over-dialog-close-btn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
					...
					._('</div>')
					._('<p class="dialog-copyright"><span class="btn lottery-close" data-collect="true" data-collect-flag="js-eyes-daily-over-konw-btn" data-collect-desc="返回按钮">我知道啦</span><br />更多信息请关注公众号“江苏新闻”</p>')
				._('</div>')
				._('</section>');
				return t.toString();
			}
