		...
		fillResult: function(data) {
			...
			for (var i = 0; i < length; i ++) {
				t._('<div class="swiper-slide" id="reserve' + i + '">')
					...
					._('<span class="reserve" data-reserveid="' + items[i].pd + '" data-collect="true" data-collect-flag="js-lizhi-duanwu-reserve-reservebtn" data-collect-desc="预约页-预约按钮">预约</span>')
				._('</div>')
			};
