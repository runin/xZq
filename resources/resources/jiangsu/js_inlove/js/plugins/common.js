...
var showTips = function(word, timer) {
	...
	$('body').append('<div class="tips none" style="position:fixed;max-width:80%;top:0;z-index:999;color:#FFF;padding:'+ paddingValue+';background:rgba(0,0,0,.55);font-size:'+fontSizeValue+';text-align:center;border-radius:'+borderRadiusValue+';z-index: 199999;"></div>');
...
$(function() {
	...
	$('.copyright').html(copyright ? copyright : '');
	$.ajax({
		type : "get",
		async : false,
