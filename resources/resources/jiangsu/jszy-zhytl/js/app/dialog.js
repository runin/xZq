            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'top': Math.round((height-288)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "280px",
                        ...
                        'top': Math.round((height-346)/2)+'px'
                    });
                }
            },
            close: function () {
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'top': Math.round((height-333)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "320px",
                        ...
                        'top': Math.round((height-426)/2)+'px'
                    });
                }
            },
            close: function() {
                    ...
                    ._('<section class="dialog redbag-dialog" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-立即领取按钮">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-领取红包按钮"><img src="images/config.png" /></a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            ...
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮"><img src="images/config.png" /></a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
