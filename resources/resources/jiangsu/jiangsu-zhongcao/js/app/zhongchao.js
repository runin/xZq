...
$(function() {
    ...
    N.module("firstPage", function(){
		...
		var mainFn = {
			...
			nowTake: function(zuuid, kuuid, su) {//判断是否已经选择了球队
				var that = this;
				if(su) {
		...
		var lgzwJk = {
			...
			drum: function() {//开始擂鼓计数
				...
				$(".drumclick").click(function(e) {
					...
					if(great == true) {
						great = false;
						lgtime = setTimeout(function(){
							$(".great-left,.great-right").toggleClass("on");
							clearInterval(lgtime);
							great = true;
						},500);
					}
