    ...
    var runTime = function() {
        ...
        vthis.each(function() {
            ...
            var showTime = function(rT, showTpl) {
                ...
                var h_ = subNum(dateNum(Math.floor(rT / 3600000)));
                // nthis.html(showTpl.replace(/%S%/, s_).replace(/%M%/, m_).replace(/%H%/, h_).replace(/%D%/, d_).replace(/%SS%/, ss_));
                nthis.html(showTpl.replace(/%S%/, s_).replace(/%M%/, m_).replace(/%H%/, h_).replace(/%SS%/, ss_));
            };
            if (sT > 0) {
                showTime(sT, s.stpl);
...
var getFriendUrl = function(openid) {
    var href = window.location.href;
    href = add_param(share_url.replace(/[^\/]*\.html/i, sharePage), 'resopenid', hex_md5(openid), true);
    href = add_param(href, 'from', 'share', true);
    href = delQueStr(href, "openid");
...
var getActsUrl = function(url, page, au) {
    var href = url || window.location.href;
    href = add_param(href.replace(/[^\/]*\.html/i, page || 'index.html'), 'resopenid', hex_md5(openid), true);
    href = add_param(href, 'from', 'share', true);
    href = add_param(href, 'destOpenid', openid, true);
    href = add_param(href, 'uname', encodeURIComponent($.trim(nickname)), true);
    if (au) href = add_param(href, 'au', au, true);
...
getActsShareUrl = function(url, page) {
    var href = url || window.location.href;
    href = add_param(href.replace(/[^\/]*\.html/i, page || 'index.html'), 'resopenid', hex_md5(openid), true);
    href = add_param(href, 'from', 'share', true);

    href = delQueStr(href, 'destOpenid');
    href = delQueStr(href, 'uname');
    href = delQueStr(href, 'au');
