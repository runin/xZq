...
$(function () {
    ...
    $.ajax({
        type : "get",
        async : false,
        url : auth_domain_url + "api/common/versioncheck",
        dataType : "jsonp",
        jsonp : "callback",
...
//        if (/192.168.0.169/.test(domain_url)) {
//            if (!param.data) {
//                param.data = {};
//            }
...
var getTangYangClass = function(level) {
    var className= "tang-yuan-a";
    switch(level){
        case 1: 
          className= "tang-yuan-a";
          break; 
        case 2:
         className= "tang-yuan-b";
          break; 
        case 3:
         className= "tang-yuan-c";
          break; 
        case 4:
           className= "tang-yuan-d";
         break;   
    }
    return className;
}
...
//pet_nos=pet_no1,pet_no2,pet_no3,pet_no4
//pet_styles=pet_them1,pet_them2,pet_them3,pet_them4
