(function ($) {
    ...
    H.nothing = {
        ...
        show: function(pi, from){
            H.nothing.from = from;

            H.nothing.$dialog.find('.award-images img').attr('src', pi);
            ...
            setTimeout(function(){
                ...
                H.nothing.$dialog.addClass('bounceInDown');
            },100);
        },
        ...
        close: function(){
            H.nothing.$dialog.removeClass('bounceInDown').addClass('bounceOutUp');
            setTimeout(function(){
                H.nothing.$dialogWrapper.addClass('none');
                H.nothing.$dialog.removeClass('bounceOutUp');
            }, 500);
