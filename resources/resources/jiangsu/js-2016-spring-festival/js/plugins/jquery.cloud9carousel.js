...
;(function($) {
  ...
  var Item = function( element, options ) {
    ...
    if( options.mirror && this.element.tagName === 'IMG' ) {
      ...
      $reflection.css( 'width', imgw);
      element.style.width = imgw;
  ...
  var Carousel = function( element, options ) {
    ...
    this.floatIndex = function() {
	  ...
	  //var i = parseInt(floatIndex);
	  //$(".cloud9-item").find("img").css("-webkit-transform","translateY(0)");
	  //$("#id"+i).find("img").css("-webkit-transform","translateY(-15px)");
    ...
    this.nearestItem = function() {
	  //$("#id"+this.floatIndex()).css("top","-20px");
  ...
  $.fn.Cloud9Carousel = function( options ) {
    return this.each( function() {
      ...
      options = $.extend( {
        ...
        xRadius: xR,
        yRadius: yR,
        farScale: 0.9,        // scale of the farthest item
