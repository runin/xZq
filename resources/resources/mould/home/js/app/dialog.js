                        ...
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ...
                                ._('<section class="lottery-cover">')
                                    ...
                                    ._('</section>')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">领&nbsp;&nbsp;取</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-good" id="good-dialog">')
                    ._('<section class="dialog good-dialog">')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-good-btn-close" data-collect-desc="弹层(商城)-关闭按钮"></a>')
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ...
                                ._('<section class="input-box goodBack none">')
                                    ...
                                    ._('<p><span>地址：</span><label class="address"></label></p>')
                                ._('</section>')
                            ._('</section>')
                            ._('<a href="javascript:void(0);" class="btn btn-good-lottery-award" id="btn-payGood-award" data-collect="true" data-collect-flag="dialog-good-btn-payGood-award" data-collect-desc="弹层(商城)-确认兑换按钮">确认兑换</a>')
                            ._('<a href="javascript:void(0);" class="btn btn-good-lottery-other none" id="btn-payGood-other" data-collect="true" data-collect-flag="dialog-good-btn-payGood-other" data-collect-desc="弹层(商城)-查看其它商品按钮">查看其它商品</a>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
