; (function (w) {
    w.matk = "tywtswesdfs8"//$.fn.cookie(mpappid + '_matk');
    w.openid = "tywtswesdfs8"//$.fn.cookie(mpappid + '_openid');
    w.headimgurl = "1ddsssa"//$.fn.cookie(mpappid + '_headimgurl');
    w.nickname = "1ddsssa"//$.fn.cookie(mpappid + '_nickname');
