                        ...
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ...
                                ._('<section class="lottery-cover">')
                                    ...
                                    ._('</section>')
                                    ._('<p class="award-keyTips"></p>')
                                    ._('<a href="javascript:;" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">领&nbsp;&nbsp;取</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ...
                                ._('<section class="lottery-cover">')
                                    ...
                                    ._('</section>')
                                    ._('<p class="award-keyTips"></p>')
                                    ._('<a href="javascript:;" class="btn-lottery btn-jifen-lottery-award" id="btn-jifenLottery-award" data-collect="true" data-collect-flag="dialog-jifen-btn-jifenLottery-award" data-collect-desc="弹层(实物)-领取按钮">领&nbsp;&nbsp;取</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
