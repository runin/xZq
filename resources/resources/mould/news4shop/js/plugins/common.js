...
$(function() {
    ...
    $('body').append('<style>.pageShow{-webkit-animation-name: pageShow;animation-name: pageShow;-webkit-transform-origin: center center;transform-origin: center center;} @-webkit-keyframes pageShow {0% {opacity: 0;}100% {opacity: 1;}}@keyframes pageShow {0% {opacity: 0;}100% {opacity: 1;}}.pageHide{-webkit-animation-name: pageHide;animation-name: pageHide;-webkit-transform-origin: center center;transform-origin: center center;} @-webkit-keyframes pageHide {0% {opacity: 1;}100% {opacity: 0;}}@keyframes pageHide {0% {opacity: 1;}100% {opacity: 0;}}</style>').addClass('pageShow animated');
});