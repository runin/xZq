; (function (w) {
    ...
    w.headimgurl = $.cookie(mpappid + '_headimgurl');
    w.nickname = $.cookie(mpappid + '_nickname');
    ...
    Authorize.prototype.init =function(fn){
        ...
        if (!headimgurl) {
            ...
            headimgurl && $.cookie(mpappid + '_headimgurl', headimgurl, expires_in);
        } else {
            $.cookie(mpappid + '_headimgurl', headimgurl, expires_in);
        }
        if (!nickname) {
            nickname = that.getQueryParam("nickname");
            nickname && $.cookie(mpappid + '_nickname', nickname, expires_in);
        } else {
            $.cookie(mpappid + '_nickname', nickname, expires_in);
        }
    }
    ...
    var shaketv_openid  = $.cookie(shaketv_appid + '_openid');
    ...
    var check_weixin_login = function() {
        ...
        if (!shaketv_openid) {
            ...
            $.cookie(shaketv_appid + '_openid', shaketv_openid, expires_in);
        }
    };
    ...
    var get_info = function(code) {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                data.openid && $.cookie(shaketv_appid + '_openid', data.openid, expires_in);
