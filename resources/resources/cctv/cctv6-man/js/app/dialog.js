(function($) {
	H.dialog = {
		...
		share: {
			...
			open: function() {
				H.dialog.open.call(this);
				var share_text = (nickname ||"我")+"有一个新年愿望";
				window['shaketv'] && shaketv.wxShare(share_img,share_text,H.index.comment, getUrl(openid));
				this.event();
			},
			event: function() {
				var me = this;
				$('#share-dialog').click(function(e) {
					e.preventDefault();
					H.dialog.close.call(this);
					H.index.$inputCmt.val("").removeAttr("disabled");
			...
			tpl: function() {
				var t = simpleTpl();
				t._('<section class="modal" id="share-dialog">')
			...
			tpl: function() {
				...
				t._('<section class="modal" id="thank-dialog">')
					._('<div class="dialog thank-dialog">')
						._('<div class="dialog-assist">')
						._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="thankdialog-closebtn" data-collect-desc="谢谢参与弹层-关闭按钮"></a>')
				...
				t._('<section class="modal" id="lottery-dialog">')
					._('<div class="dialog lottery-dialog">')
						._('<div class="dialog-assist">')
							...
							._('<div class="lottery-head"><img src="images/lottery-head.png" /></div>')	
							._('<div class="lottery-good lottery-card">')
								._('<div class="award-img">')
									._('<img id="aw" src="" />')
								._('</div>')
								._('<div class="contact none">')
									._('<h4 class="award-tip">请如实填写联系方式，以便顺利领奖</h4>')
								...
								._('<a href="#" class="btn btn-back none" id="btn-back" data-collect="true" data-collect-flag="lotterydialog-OKbtn" data-collect-desc="抽奖弹层-实物领取返回按钮">确定</a>')
							._('</div>')
						._('</div>')
					._('</div>')
				._('</section>');
