        ...
        event: function(){
            $('.icon-surprise').click(function(e){
                ...
                if(!$(this).hasClass("clicked")){
                    ...
                    setTimeout(function(){
                        location.href = 'http://surprise-question.app.snapexport.com/home/wapIndex';
                    },800);
                }
            });
        },
        safeShowOver : function(){
            // 判断时间是否在互动时间段内
            var day = timeTransform(new Date().getTime());
            var me = this;
            if(comptime(day, day.split(" ")[0] + ' 19:30:00') < 0 && comptime(day, day.split(" ")[0] + ' 20:30:00') >= 0){
                if(me.isLottery){
                    return;
                }
                toUrl("yaoyiyao.html");
