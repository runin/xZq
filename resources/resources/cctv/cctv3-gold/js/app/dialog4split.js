    ...
    H.dialog = {
        ...
        shiwuLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-close" data-collect-desc="裂变弹层(实物奖)-关闭按钮"></a>')
                    ...
                    ._('</section>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="split-dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="裂变弹层(实物奖)-领取按钮">领取</a>')
                    ._('<section class="btn-lottery-box after">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-close" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="split-dialog-shiwu-btn-shiwuLottery-close" data-collect-desc="裂变弹层(实物奖)-继续摇奖按钮">确定</a>')
                    ._('</section>')
                    ._('</section>')
        ...
        wxcardLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="split-dialog-wxcard-btn-close" data-collect-desc="裂变弹层(卡券)-关闭按钮"></a>')
                    ._('<img class="icon-lotterydoll" src="./images/icon-lotterydoll.png">')
                    ._('<section class="dialog-content">')
                    ._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                    ._('<img class="award-img" src="./images/default-award.png">')
                    ...
                    ._('<input class="phone" type="tel" placeholder="电话:">')
                    ._('</section>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="split-dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="裂变弹层(卡券)-领取按钮">领取</a>')
                    ._('</section>')
                    ._('<img class="icon-palm" src="./images/icon-palm.png">')
                    ._('</section>')
                    ._('</section>');
        ...
        sharedialog: {
            ...
            event: function () {
                ...
                this.$dialog.find('.qrcode').click(function (e) {
                    e.preventDefault();
                    me.close();
                    toUrl("split.html?sau="+ H.dialog.sau);
                });
            },
            tpl: function () {
                var t = simpleTpl();
                t._('<section class="modal modal-rule" id="share-dialog">')
                    ._('<section class="dialog rule-dialog">')
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="split-dialog-rule-btn-close" data-collect-desc="裂变弹层(二维码)-关闭按钮"><img src="./images/btn-rule-close.png"></a>')
                    ._('<section class="dialog-content">')
                    ._('<img class="logo" src="./images/icon-sponsorlogo.png">')
                    ._('<img class="qrcode" src="./images/icon-qrcode.png">')
                    ._('<p class="tip">长按图片识别二维码<br>查看中奖纪录及咨询奖品发放情况哦</p>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>');
                return t.toString();
