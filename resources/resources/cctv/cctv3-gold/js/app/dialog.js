    ...
    H.dialog = {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-close" data-collect-desc="弹层(实物奖)-关闭按钮">X</a>')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="btn-lottery-box after">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-close" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-close" data-collect-desc="弹层(实物奖)-继续摇奖按钮">分享好友</a>')
                            ._('</section>')
                        ._('</section>')
        ...
        thanksLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="thanks-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                    ._('<section class="dialog-content">')
                    ._('<p class="award-luckTips"><img src="./images/icon-thankstip.png"></p>')
                    ._('<p class="award-thankTips">别灰心，长按二维码<br>关注能获得更多的活动优惠哦！</p>')
                    ._('<img class="award-qrcode" src="./images/icon-qrcode.png">')
                    ._('<a href="javascript:void(0);" class="btn-lottery" id="btn-thanks-continue" data-collect="true" data-collect-flag="dialog-thanks-btn-continue" data-collect-desc="弹层(谢谢参与)-继续摇奖">继续摇奖</a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>');
                return t.toString();
        ...
        sharedialog: {
            ...
            tpl: function () {
                ...
                t._('<section class="modal modal-rule" id="share-dialog">')
                    ._('<img class="sharelogo" src="./images/icon-luckdoll.png">')
                    ._('<p class="share-title">猛戳右上角<br>邀请小伙伴抽奖，你也有惊喜哦！</p>')
                    ._('<section class="dialog rule-dialog">')
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-rule-btn-close" data-collect-desc="弹层(活动规则)-关闭按钮"><img src="./images/btn-rule-close.png"></a>')
                    ._('<section class="dialog-content">')
        ...
        split: function(){
            $.ajax({
                type: 'GET',
                async: false,
                url: domain_url + 'api/split/send' + dev,
                data: { oi: openid , lru: H.dialog.lru},
                dataType: "jsonp",
                jsonpCallback: 'callbackSplitSendHandler',
                complete: function() {
                },
                success: function(data) {
                    if(data.code == 0){
                        H.dialog.sau = data.sid;
                        //打开分享弹层
                        H.dialog.sharedialog.open();
                        // 改变分享连接
                        var text = sharetext[getRandomArbitrary(0,sharetext.length)];
                        window['shaketv'] && shaketv.wxShare(share_img, text[0], text[1], getnewUrl(openid,data.sid));
                    }
                },
                error: function() {
                }
