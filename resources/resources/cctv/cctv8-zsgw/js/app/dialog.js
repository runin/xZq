                    ...
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="input-box before">')
                                ...
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">快去抢！</a>')
                            ._('</section>')
                    ...
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                           /* ._('<p class="icon-congrats">恭喜您中奖啦~</p>')*/
                            ._('<img class="award-img" src="./images/default-award.png">')
                            ._('<section class="input-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链奖)-立即使用按钮">快去抢！</a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                    ...
                    ._('<section class="dialog wxcard-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="input-box">')
                                ...
                                ._('</div>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮">快去抢！</a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
