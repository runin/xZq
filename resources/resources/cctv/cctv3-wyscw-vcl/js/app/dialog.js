    ...
    H.dialog = {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<p class="award-keyTips"></p>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即使用按钮">立即使用</a>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-lottery-close" id="btn-linkLottery-close" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-close" data-collect-desc="弹层(外链)-继续摇奖按钮">继续摇奖</a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                    ._('<section class="flash-box"><img class="icon-flash" src="./images/icon-flash.png"></section>')
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<p class="info-qrcode">长按图片识别二维码<br>可了解您的中奖情况</p>')
                            ._('<section class="btn-lottery-box">')
        ...
        shiwuLottery4vote: {
            ...
            update: function(data) {
                var me = this, height = $(window).height();
                if(data.result){
                    $("#shiwu-dialog").find(".award-nameTips").html(data.pn || '');
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<img class="award-img" src="./images/default-award.png">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-linkvote-btn-linkLottery-use" data-collect-desc="抽奖弹层(外链)-立即使用按钮">立即使用</a>')
