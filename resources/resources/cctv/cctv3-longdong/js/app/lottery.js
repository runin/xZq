    ...
    H.lottery = {
        ...
        imgMath: function() {//随机背景
            ...
            if(me.lotteryImgList.length >0){
                ...
                $("body").css("background","url('" + me.lotteryImgList[i] + "') no-repeat center center #051832");
            }
        },
        red_record: function(){
        ...
        change: function() {
            ...
            $(".countdown").removeClass('none').find(".countdown-tip").html('本期摇奖已结束，请期待下期吧！');
