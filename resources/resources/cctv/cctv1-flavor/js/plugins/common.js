...
$(function() {
	...
	if(cbUrl.indexOf('cb41faa22e731e9b') < 0 ){
		...
		$('footer .tips-slogan').css('margin-bottom', '5%');
		$('footer .btn-play').css('margin-bottom', '7%');
	} else {
		$('#div_subscribe_area').css('height', '50px');
		$('footer .tips-slogan').css('margin-bottom', '2%');
		$('footer .btn-play').css('margin-bottom', '2%');
	};
