                    ...
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-body">')
                                ...
                                ._('</section>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="./images/btn-get.png"></a>')
                    ...
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-body">')
                                ...
                                ._('<p class="award-keyTips"></p>')
                                ._('<section class="btn-lottery-box">')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链奖)-立即使用按钮"><img src="./images/btn-get.png"></a>')
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<p class="icon-sorry"><img src="./images/icon-sorry.png"></p>')
                            ._('<img class="thanks-img" src="./images/' + thanks_img[getRandomArbitrary(0,thanks_img.length)] + '">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-thanks-lottery" id="btn-thanksLottery-close" data-collect="true" data-collect-flag="dialog-thanks-btn-retry" data-collect-desc="弹层(谢谢参与)-继续摇奖按钮"><img src="./images/btn-retry.png"></a>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-thanks-happy" id="btn-thanksHappy-link" data-collect="true" data-collect-flag="dialog-thanks-happy" data-collect-desc="弹层(谢谢参与)-戳我有惊喜按钮"><img src="./images/btn-happy.png"></a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
