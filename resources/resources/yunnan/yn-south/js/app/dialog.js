        ...
        lottery: {
            ...
            open: function(data) {
                ...
                if(data.pt == 7){
                    ...
                    this.$dialog.find('.btn-red').off();
                    H.dialog.lottery.readyFunc();
                }
                //document.getElementById('aw').onload = function () {
                //    var inheight = ($(".contact").height() + $(".award-img").height() + 35) + (winH * 0.05) + 60;
                //    if(inheight >= winH){
                //        $(".award-img img").css("height","80px");
                //        inheight = ($(".contact").height() + 95) + (winH * 0.05) + 60;
                //    }
                //    $(".lottery-dialog").css({
                //        'height': inheight,
            ...
            readyFunc: function(){
                var me = this;
                this.$dialog.find('.btn-red').on("click", function (e) {
                    e.preventDefault();
                    if(!$('.btn-red').hasClass("flag")){
                        $('.btn-red').addClass("flag");
