			...
			tpl: function() {
				...
				t._('<section class="modal modal-guide" id="guide-dialog">')
					._('<div class="dialog guide-dialog relocated">')
						._('<div>看《神探包青天》微信摇一摇<h1>答题抽大奖</h1></div>')
						._('<p class="ellipsis"><label>1.</label>打开电视，锁定云南卫视</p>')
						._('<p class="ellipsis"><label>2.</label>打开微信，进入摇一摇(电视)</p>')
						._('<p class="ellipsis"><label>3.</label>对着电视摇一摇</p>')
						._('<a href="#" class="btn btn-try" data-collect="true" data-collect-flag="ah-bao-guide-trybtn" data-collect-desc="引导弹层-关闭按钮"></a>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
		...
		rule: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="yn-bao-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
		...
		rank: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rank-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="ah-bao-rankdialog-closebtn" data-collect-desc="积分排行榜弹层-关闭按钮"></a>')
					._('<div class="dialog rank-dialog">')
						._('<h2>积分排行榜</h2>')
						._('<p>全剧终积分前三名可依次获得<br>iphone 6一台、ipad mini2一台、ipod nano6 一台</p>')
		...
		fudai: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="fudai-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="yn-bao-fudaidialog-closebtn" data-collect-desc="抽奖福袋弹层-关闭按钮"></a>')
					._('<div class="fudai" data-collect="true" data-collect-flag="yn-bao-fudaidialog-click" data-collect-desc="抽奖福袋弹层-点击福袋"></div>')
		...
		lottery: {
			...
			update: function(data) {
				if (data.code === 0) {
					...
					// 中奖后
					//积分中奖文案（恭喜你获得积分，使用参照活动规则） 积分奖品 data.pt == 2
					//话费中奖文案（太棒了！恭喜你获得话费） 实物奖品 data.pt == 1
					if (data.pt === 1) {
						this.$dialog.find('h3').html('太棒了！恭喜你获得话费');
					};
					if (data.pt === 2) {
						this.$dialog.find('h3').html('<span class="jf-tips">恭喜你获得积分<br>积分使用请参照活动规则</span>');
					};
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="yn-bao-lotterydialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
								...
								._('<div class="back">')
									._('<div class="award-win none">')
										...
										._('<div class="contact">')
											...
											._('<a href="#" class="btn btn-share">返回</a>')
										._('</div>')
									._('</div>')
