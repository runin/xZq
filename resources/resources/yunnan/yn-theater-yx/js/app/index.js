(function($) {
    ...
    W.callbackArticledetailListHandler = function(data){
        if(data == undefined){
            ...
            if(data.code == 0){
                hidenewLoading();
                $("body").css({"background":"url(" + data.arts[0].img + ") no-repeat top center #FFF","background-size":"100% 100%"});
                ...
                if(H.index.isask == false){
                    ...
                    hidenewLoading();
                    $("body").css({"background":"url(images/roundbg.jpg) no-repeat top center #FFF","background-size":"100% 100%"});
