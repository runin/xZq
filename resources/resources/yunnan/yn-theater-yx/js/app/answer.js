...
(function($) {
	H.answer = {
		...
		event: function() {
			...
			$('#tolottery').click(function(e) {
				e.preventDefault();
				$('#tolottery').css({"-webkit-animation":"drop 1s","animation-timing-function":"ease-out","-webkit-animation-timing-function":"ease-out"}).on("webkitAnimationEnd", function () {
					$('#tolottery').css({"-webkit-animation":""});
				});
				toUrl("lottery.html");
			});
