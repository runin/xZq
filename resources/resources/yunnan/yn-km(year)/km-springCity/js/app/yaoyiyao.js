...
(function($) {
    H.lottery = {
        ...
        {
            $(".yao-red").css("bottom",$(window).width()*0.37)
        },
        shake: function() {
        ...
        shake_listener: function() {
            ...
            if (!$(".yao-bg").hasClass("yao")) {
                $("#audio-a").get(0).play();
                $(".yao-red").addClass("shaking");
                $(".yao-bg").addClass("yao");
                $(".yao-red img").on("webkitAnimationEnd",function()
                {
                    $(".yao-red").removeClass("shaking");
                })
        ...
        fill: function(data) {
            ...
            if (data.pt == 7 || data.pt == 9) {
                ...
                //兑换码或者实物奖
                H.dialog.wailianSpec.open(data);
            }
            else if( data.pt == 0)
            {   
               //谢谢参与
