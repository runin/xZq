        ...
        rule: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="rule-dialog">')
                    ...
                    ._('<div class="rule-title"><img src="./images/rule-title.png" alt="" /></div>')
        ...
        wailianSpec: {
            ...
            tpl: function() {
                ...
                t._('<div class="modal modal-lottery" id="Entlottery-dialog">')
                    ...
                    ._('<div class="luck-title"><img src="./images/luck-title.png" alt="" /></div>')
                    ...
                    ._('<img class="award-img" src="./images/winafter.png">')
                    ._('</div>')
                    ._('</div>')
                    ._('</div>');
                return t.toString();
