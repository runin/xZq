    ...
    H.lottery = {
        ...
        event: function() {
            ...
            $('#avatar').click(function(e) {
                ...
                $('#J_guide').addClass('none');
            });
            $('#J_voteControl').click(function(e) {
                e.preventDefault();
                if (!$('#J_cover').hasClass('moveTransOut')) {
                    $('#J_cover .avatar').addClass('touch-none');
        ...
        fillUserInfo: function() {
            $('#avatar img, #J_userControl h1 .avatar').attr('src', headimgurl ? headimgurl : './images/avatar.jpg');
            $('#J_userControl h1 p').text(nickname ? nickname : '匿名用户');
        },
        shake: function() {
        ...
        servicePVPort: function(){
            getResult('api/common/servicedaypv', {}, 'commonApiSDPVHander',false);
        },
        ...
        shake_listener: function() {
            if (!H.lottery.safeFlag) {
                if($('#J_cover').hasClass('moveTransIn')) return;
        ...
        imgMath: function() {//随机背景
            ...
            if(me.lotteryImgList.length >0){
                ...
                $("#J_lotteryBox").css("background","url('" + me.lotteryImgList[i] + "') no-repeat center center");
            }
        },
        red_record: function() {
        ...
        downloadImg: function(){
            ...
            $("#J_lotteryBox").append(t.toString());
        },
    ...
    W.callbackLotteryAllRecordHandler = function(data){
        if(data.result){
            ...
            if(recordList && recordList.length > 0){
                ...
                tpl += '</ul>';
                $("#marqueen").animate({'transform':'translate3d(-500px,0,0)'}, 1000, function(){
                    $("#marqueen").css({'transform':'translate3d(500px,0,0)','opacity':'1'}).animate({'transform':'translate3d(500px,0,0)'}, 1000, function(){
                        ...
                        setTimeout(function(){
                            $("#marqueen").animate({'transform':'translate3d(0,0,0)'}, 1000);
                        }, 1000);
                    });
                });
            }
