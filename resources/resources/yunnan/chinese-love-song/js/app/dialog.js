    ...
    H.dialog = {
        ...
        redbagLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-redbag-btn-close" data-collect-desc="弹层(红包)-关闭按钮">X</a>')
        ...
        shiwuLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-close" data-collect-desc="弹层(实物)-关闭按钮">X</a>')
                    ._('<section class="dialog-content">')
                    ._('<div class="award-img">')
                    ._('</div>')
        ...
        jifenLottery: {
            ...
            update: function(data) {
                var me = this;
                if (data.result) {
                    $("#shiwu-dialog").find(".jf-img").attr("src", data.pi);
                    // $("#shiwu-dialog").find(".award-keyTips").html(data.pn || '');
                    //$("#shiwu-dialog").find(".name").val(data.rn ? data.rn : '');
                    //$("#shiwu-dialog").find(".phone").val(data.ph ? data.ph : '');
                    //$("#shiwu-dialog").find(".address").val(data.ad ? data.ad : '');
            ...
            tpl: function() {
                var t = simpleTpl();
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog jf">')
                ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-jf-btn-close" data-collect-desc="弹层(实物)-关闭按钮">X</a>')
                ._('<section class="dialog-content">')
                    ._('<div class="award-img">')
                        ._('<img class="jf-img" data-collect="true" data-collect-flag="dialog-jf-img" data-collect-desc="弹层(积分)-中奖图">')
                    ._('</div>')
                    ._('<section class="input-box before">')
                    //._('<h5>请填写您的联系方式，以便顺利领奖</h5>')
                    //._('<p><input class="name" type="text" placeholder="姓名："></p>')
        ...
        linkLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-closebtn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-link-btn-close" data-collect-desc="弹层(外链)-关闭按钮">X</a>')
                    ._('<section class="dialog-content">')
                    ._('<div class="award-img">')
                    ._('</div>')
                    ._('<section class="btn-lottery-box">')
        ...
        thanks: {
            ...
            pre_dom: function() {
                ...
                //         'width': "240px",
                //         'height': "300px",
                //         'left': Math.round((width-240)/2)+'px',
                ...
                //         'height': "360px",
                //         'left': Math.round((width-280)/2)+'px',
                //         'top': Math.round((height-360)/2)+'px'
                //     });
                // }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ...
                    ._('<h3 class="tlt">长按二维码关注公众号 <br/>更多惊喜等着你~</h3>')
