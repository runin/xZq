var addressInit = function(c, f, a, l, d, o) {
	...
	function m() {
		...
		var q = g.options[g.selectedIndex].obj;
		for (var p = 0; p < q.cityList.length; p++) {
			h(j, q.cityList[p].name, q.cityList[p])
		}
		e(j, d);
	}
	for (var k = 0; k < provinceList.length; k++) {
		h(g, provinceList[k].name, provinceList[k])
	}
	e(g, l);
	m();
	g.onchange = m
...
var provinceList = [
{
	...
	cityList: [{
		name: "市辖区",
		areaList: ["万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区"]
	}, {
		name: "县",
	...
	cityList: [{
		...
		name: "开封市",
		areaList: ["龙亭区", "顺河回族区", "鼓楼区", "禹王台区", "金明区", "杞　县", "通许县", "尉氏县", "开封县", "兰考县"]
	}, {
		name: "洛阳市",
	...
	cityList: [{
		...
		name: "沧州市",
		areaList: ["辖区", "新华区", "运河区", "沧　县", "青　县", "东光县", "海兴县", "盐山县", "肃宁县", "南皮县", "吴桥县", "献　县", "孟村回族自治县", "泊头市", "任丘市", "黄骅市", "河间市"]
	}, {
		name: "廊坊市",
		areaList: ["辖区", "安次区", "广阳区", "固安县", "永清县", "香河县", "大城县", "文安县", "大厂回族自治县", "霸州市", "三河市"]
	}, {
		name: "衡水市",
	...
	cityList: [{
		...
		name: "阳泉市",
		areaList: ["辖区", "城　区", "矿　区", "郊　区", "平定县", "盂　县"]
	}, {
		name: "长治市",
	...
	cityList: [{
		...
		name: "鄂尔多斯市",
		areaList: ["市辖区", "东胜区", "达拉特旗", "准格尔旗", "鄂托克前旗", "鄂托克旗", "杭锦旗", "乌审旗", "伊金霍洛旗"]
	}, {
		name: "呼伦贝尔市",
	...
	cityList: [{
		...
		name: "苏州市",
		areaList: ["工业园区", "沧浪区", "平江区", "金阊区", "高新区", "虎丘区", "吴中区", "相城区", "常熟市", "张家港市", "昆山市", "吴江市", "太仓市"]
	}, {
		name: "南通市",
		...
		name: "扬州市",
		areaList: ["市辖区", "广陵区", "邗江区", "维扬区", "宝应县", "仪征市", "高邮市", "江都市"]
	}, {
		name: "镇江市",
	...
	cityList: [{
		...
		name: "芜湖市",
		areaList: ["镜湖区", "弋江区", "鸠江区", "三山区", "芜湖县", "繁昌县", "南陵县"]
	}, {
		name: "蚌埠市",
	...
	cityList: [{
		name: "沈阳市",
		areaList: ["市辖区", "和平区", "沈河区", "大东区", "皇姑区", "铁西区", "苏家屯区", "东陵区", "沈北新区", "于洪区", "辽中县", "康平县", "法库县", "新民市"]
	}, {
		name: "大连市",
	...
	cityList: [{
		...
		name: "白山市",
		areaList: ["八道江区", "抚松县", "靖宇县", "长白朝鲜族自治县", "江源区", "临江市"]
	}, {
		name: "松原市",
	...
	cityList: [{
		...
		name: "大兴安岭地区",
		areaList: ["加格达奇区", "松岭区", "新林区", "呼中区", "呼玛县", "塔河县", "漠河县"]
	}]
}, {
	name: "海南",
	cityList: [{
