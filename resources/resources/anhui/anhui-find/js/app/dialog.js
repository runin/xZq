		...
		guide: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-guide" id="guide-dialog">')
					...
					._('<p class="ellipsis"><label class="sec"></label><span class="sec-span">打开微信，进入摇一摇(歌曲)</span></p>')
					._('<p class="ellipsis fina"><label class="thir"></label>摇动手机，即可参与栏目互动</p>')
					._('<a href="#" class="btn btn-try" data-collect="true" data-collect-flag="anhui-find-guide-trybtn" data-collect-desc="安徽电视台我要找到你引导弹层-关闭按钮">等下去试试</a>')
					._('</div>')
					._('</section>');
				return t.toString();
			}
		...
		rule: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-rul" id="rule-dialog">')
					...
					._('</div>')
					._('<p class="dialog-copyright"><a href="#" class="btn my-zhidao close" data-collect="true" data-collect-flag="anhui-find-guide-trybtn" data-collect-desc="安徽电视台我要找到你规则弹层-我知道了按钮">我知道了</a></p>')
					._('</div>')
					._('</section>');
				return t.toString();
			}
