    ...
    H.dialog = {
        ...
        qtcode: {
            ...
            update: function(data) {
                ...
                $(".qtcode-dialog").find(".award-luckEt").html("太遗憾啦，没中奖");
                //$(".qtcode-dialog").find(".award-luckEt").html("恭喜您获得<br/>"+data.pn);
                //$(".qtcode-dialog").find(".t-img").attr("src",data.pi);
                var lotteryW = winW * 0.74,
                    lotteryH = winH * 0.60,
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-rul" id="qtcode-dialog">')
                    ...
                    ._('<img src="images/chk.jpg" class="t-img">')
                    ._('<p class="award-luck">长按图片识别二维码,更多优惠等您</p>')
                    ._('<a href="#" class="qtcode-close" data-collect="true" data-collect-flag="qtcode-closebtn" data-collect-desc="二维码弹层-关闭按钮">确&nbsp&nbsp&nbsp定</a>')
                    ._('<img src="images/pic1.png" class="t-pic1">')
                    ._('<img src="images/pic2.png" class="t-pic2">')
                    ._('<img src="images/pic3.png" class="t-pic3">')
                    ._('</div>')
                    ._('</section>');
                return t.toString();
            }
        ...
        lottery: {
			...
			update: function(data) {
                ...
                if(data.result && (data.pt == 7 || data.pt == 9 || data.pt == 4)){
                    ...
                    $(".lottery-dialog").find(".award-luckEt").html("恭喜您获得<br/>"+data.pn);
                    $('.award-img').css({
                        'width': "70%"
                    });
                    if(data.cu == 1){
				...
				t._('<div class="modal modal-lottery" id="lottery-dialog">')
					...
					//._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="dialog-task-juan-link-close-btn" data-collect-desc="中奖弹层业务类(卡券-外链)-关闭按钮"></a>')
                        ...
                        ._('<div class="lott-box" id="lott">')
                            ...
                            ._('<a class="lottery-btn" id="btn-getluck" href="#" data-collect="true" data-collect-flag="dialog-task-quan-link-get-btn" data-collect-desc="中奖弹层业务类(卡券-外链)-领取按钮">领&nbsp&nbsp&nbsp取</a>')
        ...
        Entlottery: {
            ...
            update: function(data) {
                ...
                if(data.result && data.pt == 5){
                    ...
                    $("#Entlottery-dialog").find(".award-luckEt").html("恭喜您获得<br/>"+data.pn);
                    $("#Entlottery-dialog").find(".award-img").attr("src",data.pi);
                    ...
                    ._('<div class="dialog lottery-dialog Entlottery-dialog">')
                        ...
                        ._('<div class="lott-box" id="ent-lott">')
                            ...
                            ._('<div class="inp" id="ent-inp">')
                                ...
                                ._('<a class="lottery-btn" id="btn-award" data-collect="true" data-collect-flag="dialog-task-Entlottery-award-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-提交信息按钮">领&nbsp&nbsp&nbsp取</a>')
                            ._('</div>')
                            ...
                            ._('<div class="result none" id="ent-result">')
                                ...
                                ._('<a class="lottery-btn" id="btn-link" data-collect="true" data-collect-flag="dialog-task-Entlottery-link-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-领取按钮">领&nbsp&nbsp&nbsp取</a>')
                                ._('<a class="lottery-btn" id="btn-sure" data-collect="true" data-collect-flag="dialog-task-Entlottery-sure-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-返回按钮">返&nbsp&nbsp&nbsp回</a>')
                            ._('</div>')
                    ._('<img src="images/pic1.png" class="t-pic1">')
                    ._('<img src="images/pic2.png" class="t-pic2">')
                    ._('<img src="images/pic3.png" class="t-pic3">')
            ...
            check:function(){
                ...
                if (name.length > 20 || name.length == 0) {
                    ...
                    showTips('请填写正确手机号，以便顺利领奖！');
                    return false;
                }else if (address.length > 30 || address.length == 0) {
        ...
        Redlottery: {
            ...
            update: function(data) {
                ...
                if(data.result && data.pt == 4){
                    ...
                    $(".redlottery-dialog").find(".award-luckEt").html("恭喜您获得<br/>"+data.pn);
