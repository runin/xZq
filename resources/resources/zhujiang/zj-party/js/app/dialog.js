                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('</section>')
                            ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="images/btn-lj.png"></a>')
                            ._('<section class="btn-lottery-box after">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-close" id="btn-shiwuLottery-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-close" data-collect-desc="弹层(实物)-继续摇奖按钮"><img src="images/jxyj.png"></a>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮"><img src="images/btn-lj.png" /></a>')
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ._('<section class="dialog wxcard-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            /*._('<p class="award-keyTips"></p>')*/
                            ._('<img class="award-img" src="">')
                            ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮"><img src="images/btn-lj.png" /></a>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'height': "314px",
                        'left': Math.round((width-280)/2)+'px',
                        'top': Math.round((height-314)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "310px",
                        'height': "348px",
                        'left': Math.round((width-310)/2)+'px',
                        'top': Math.round((height-348)/2)+'px'
                    });
                }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-card" id="sentCard">')
                    ...
                    ._('<section class="icon none" id="icon">')
                        ._('<div class="icon-rays" data-collect="true" data-collect-flag="dialog-sent-btn-close" data-collect-desc="弹层(明星语音)-关闭按钮"></div>')
                        ._('<img class="xf" src="images/xf.jpg" />')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            }
