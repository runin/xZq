    ...
    H.lottery = {
        ...
        event: function() {
            ...
            $(".jmd ").on('tap',function(e){
                e.preventDefault();
                me.btn_animate($(this));
                W.location.href = "http://a2.rabbitpre.com/m/uaeima9?lc=1&sui=PXXH0jIY&from=singlemessage&isappinstalled=0#from=share";
            });
        ...
        red_record: function(){
            getResult('api/lottery/allrecord', {pt: 1}, 'callbackLotteryAllRecordHandler');
        },
        //查询当前参与人数
        ...
        fill: function(data) {
            ...
            //0:谢谢参与1:实物奖品2:积分奖品3:滴滴红包4:现金红包5:兑换码奖品6:流量红包7:电子卡券8:奖品包9:外链领取奖品10闯关类型奖品
            if (data.pt == 1) {
