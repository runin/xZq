...
var showTips = function(tips, timer) {
    ...
    if (showTipsFlag) {
        showTipsFlag = false;
        $('body').append('<div class="showTips" style="position:fixed;max-width:80%;z-index:999999999999;color:#FFF;padding:15px 18px;font-size:17px;border-radius:10px;background:rgba(0,0,0,.7);text-align:center;opacity:0">' + tips + '</div>');
