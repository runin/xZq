        ...
        shiwuLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="./images/lottery-btn.jpg"></a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
        ...
        linkLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ...
                    ._('</div>')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮"><img src="./images/lottery-btn.jpg"></a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>');
