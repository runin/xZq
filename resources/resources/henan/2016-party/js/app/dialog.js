            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ._('<section class="dialog redbag-dialog" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-立即领取按钮">')
                        ...
                        ._('<section class="dialog-bg">')
                            ._('<img class="gai" src="images/dialog-gai.png" />')
        ...
        thanks: {
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'top': Math.round((height-326)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "310px",
                        'height': "421px",
                        'left': Math.round((width-310)/2)+'px',
                        'top': Math.round((height-421)/2)+'px'
                    });
                }
            },
            close: function() {
            ...
            textMath: function() {//随机img
                ...
                if(thanks_imgs.length >0){
                    ...
                    me.randomSrc = thanks_imgs[i].im;
                    me.randName = thanks_imgs[i].name;
                    me.audioSrc = thanks_imgs[i].src;
                }
            },
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ...
                        ._('<p class="triangle-right" data-collect="true" data-collect-flag="zj-party-sharego-audio" data-collect-desc="播放语音">')
                            ._('<i></i><audio preload="auto" class="audio none" src="'+ me.audioSrc +'" id="music"></audio>')
                            ._('<span class="duri"></span>')
                        ._('</p>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
