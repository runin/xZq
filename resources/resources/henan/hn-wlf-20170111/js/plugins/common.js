	...
	$.fn.marqueen = function(options){
		...
		return this.each(function(){
			...
			switch(opts.mode){
				...
				case "top":
					container.children().clone().appendTo(container).clone().prependTo(container);
					container.wrap('<div class="mqWrapper" style="overflow:hidden;position:relative;height:'+opts.row*slideH+'px"></div>').css( { "height":containerSize*slideH*3,"position":"relative","padding":"0","margin":"0","top":-containerSize*slideH}).children().css({"width":"auto","margin":"0","height":selfH});
					break;
			}
			var doPlay = function(){
				switch(opts.mode){
