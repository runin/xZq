(function($) {
    H.lottery = {
        ...
        $voteLottery: $("#vote-lottery-countdown"),//投票页摇奖倒计时
        init: function() {
            var me = this;
        ...
        initComponent: function(){
            var me = this, recordDelay = Math.ceil(15000*Math.random());
        ...
        beforeCountdown: function(prizeActList) {
            ...
            me.downloadImg();
            hidenewLoading();
            me.$voteLottery.removeClass('none');
        ...
        nowCountdown: function(prizeActList){
            ...
            me.downloadImg();
            hidenewLoading();
            me.$voteLottery.addClass('none');
            me.$goLottery.removeClass("none");
