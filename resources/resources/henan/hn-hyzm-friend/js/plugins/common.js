			...
			if (typeofAppid == 'undefined' || typeofAppid == '' || typeofAppid == null) {
				...
				if(openid){
                    if($("body").attr("data-type") == "index"){
                        follow_shaketv_appid = follow_shaketv_appid_index;
                    }else{
                        follow_shaketv_appid = follow_shaketv_appid_yao;
                    }
