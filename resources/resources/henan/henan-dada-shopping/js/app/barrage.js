                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        if (data.code == 0) {
							...
							barrage.appendMsg('<div><div class="c_head_img isme"><img class="c_head_img_img" src="'+H.comment.randIcon()+'" /></div><div class="comment">'+comment+'</div></div>');
