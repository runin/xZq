        ...
        redbagLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-领取红包按钮"><img src="./images/lottery-btn.jpg"></a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>');
        ...
        wxcardLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ...
                    ._('</div>')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮"><img src="./images/lottery-btn.jpg"></a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>');
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ...
                    ._('<h3 class="tlt">更多现金大奖，长按此二维码<br/>关注勇士官微，大奖等您拿</h3>')
