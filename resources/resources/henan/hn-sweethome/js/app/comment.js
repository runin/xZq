(function($) {
	H.talk = {
        ...
        getGameUrl:function()
        {
            getResult("api/comments/topic/round",{},"callbackCommentsTopicInfo",false);
        },
        setGameUrl:function(gameurl)
        {
             $(".wrap-game").attr("data-url",gameurl);       
        },
		eventHandle:function()
		{
			var me = this;
            $(".wrap-game").click(function(){
                var gameurl = $(".wrap-game").attr("data-url");       
    ...
    W.callbackCommentsTopicInfo = function(data)
    {
        if(data.code == 0)
        {
            H.talk.setGameUrl(data.items[0].c);
        }
        else
        {
