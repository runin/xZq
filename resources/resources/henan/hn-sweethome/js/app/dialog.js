        ...
        Entlottery: {
            ...
            tpl: function() {
                ...
                ._('</div>')
                    ...
                    ._('<a class="lottery-btn none" id="btn-sure" data-collect="true" data-collect-flag="dialog-task-Entlottery-sure-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-返回按钮">返    回</a>')
                    ._('</div>')
                    ._('</div>');
                return t.toString();
            },
        ...
        Tellottery: {
            ...
            tpl: function() {
                ...
                t._('<div class="modal modal-lottery" id="Tellottery-dialog">')
                    ...
                    ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="dialog-task-tellottery-close-btn" data-collect-desc="中奖弹层业务类(流量红包)-关闭按钮"></a>')
                    ._('<img class="award-logo" src="./images/lottery-title.png">')
                    ._('<p class="award-lpt"></p>')
                    ._('<img class="award-img" src="./images/gift-blank.png">')
        ...
        prizesList: {
            ...
            update: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    t._('<li><img src="' + data[i].pi + '"></li>')
                }
                $(".list-context").append(t.toString());
            },
            tpl: function() {
                var t = simpleTpl();
                t._('<div class="modal modal-lottery" id="Redlottery-dialog">')
                    ._('<div class="dialog prizesList-dialog">')
                    ._('<a class="lottery-btn" id="btn-red" data-collect="true" data-collect-flag="dialog-task-red-close-btn" data-collect-desc="中奖弹层业务类(红包)-领取按钮">奖&nbsp;&nbsp;品&nbsp;&nbsp;列&nbsp;&nbsp;表</a>')
                    ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="dialog-task-Redlottery-close-btn" data-collect-desc="中奖弹层业务类(红包)-关闭按钮"></a>')
                    ._('<ul class="list-context">')
                    ._('</ul>')
                    ._('</div>')
                    ._('</div>');
                return t.toString();
        ...
        thanks: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-rul" id="thanks-dialog">')
                    ...
                    ._('<a href="#" class="btn-close"  data-collect="true" data-collect-flag="dialog-task-thanks-close-btn" data-collect-desc="谢谢参与-关闭按钮"></a>')
