(function($) {
    H.dialog = {
        ...
        redbagLottery: {
            ...
            pre_dom: function() {
                ...
                if (W.screen.width === 320) {
                    $(".dialog").css({
                        ...
                        'top': Math.round((height - 405) / 2) + 'px'
                    });
                } else {
                    $(".dialog").css({
                        'width': "312px",
                        ...
                        'top': Math.round((height - 550) / 2) + 'px'
                    });
                }
            },
            close: function() {
            ...
            update: function(data) {
                ...
                if (data.result) {
                    me.rp = data.rp;
                    $(".redbag-dialog").find(".award-img").css("background-image", "url(" + data.pi + ")");
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    // ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-redbag-btn-close" data-collect-desc="弹层(红包)-关闭按钮"></a>')
                        ._('<section class="dialog-content">')
                            ._('<div class="award-img"></div>')
                        ._('</section>')
                        ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-领取红包按钮"><img src="./images/lottery-btn.png"></a>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close hot-b" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-shiwu-btn-close" data-collect-desc="弹层(实物)-关闭按钮"></a>')
                        ._('<section class="dialog-content">')
                            ...
                            ._('</section>')
                        ._('</section>')
                        ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="./images/lottery-btn.png"></a>')
                    ._('</section>')
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                            ...
                            //._('<p><input class="address" type="text" placeholder="收件地址："></p>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award before" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-jfLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="./images/lottery-btn.png"></a>')
                            ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            ...
            event: function(SID) {
                ...
                this.$dialog.find('#btn-linkLottery-use').click(function(e) {
                    ...
                    if (me.ru.length == 0) {
                        ...
                        setTimeout(function() {
                            if(me.qc !== ''){
                                toUrl("card.html?SID="+SID+"&Simg="+me.qc+"&isSelf=true");
                            }else{
                                location.href = me.ru;
                            }
                        }, 500);
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close hot-b" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-link-btn-close" data-collect-desc="弹层(外链)-关闭按钮"></a>')
                        ._('<section class="dialog-content">')
                            ._('<div class="award-img">')
                            ._('</div>')
                        ._('</section>')
                        ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮"><img src="./images/lottery-btn.png"></a>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            }
        ...
        duiHuanMaLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="dhm-dialog">')
                    ...
                    ._('<a href="javascript:void(0);" class="btn-dialog-close hot-b" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-dhm-btn-close" data-collect-desc="弹层(兑换码)-关闭按钮"></a>')
                    ._('<section class="dialog-content">')
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ._('<section class="dialog wxcard-dialog">')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close hot-b" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-wxcard-btn-close" data-collect-desc="弹层(卡券)-关闭按钮"></a>')
                        ._('<section class="dialog-content">')
                            ._('<div class="award-img">')
                            ._('</div>')
                        ._('</section>')
                        ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮"><img src="./images/lottery-btn.png"></a>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            }
            ...
            pre_dom: function() {
                ...
                if (W.screen.width === 320) {
                    ...
                    $(".dialog").css({
                        ...
                        'height': "434px",
                        'left': Math.round((width - 312) / 2) + 'px',
                        'top': Math.round((height - 434) / 2) + 'px'
                    });
                }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ._('<section class="dialog-content">')
                            ._('<div class="top-bar">')
                        //._('<img class="award-tips" src="./images/pitytitle.png">')
                            ._('</div>')
                        ._('<img class="icon-thanks" src="' + me.randomSrc + '">')
                        ._('<h3 class="tlt">长按二维码关注公众号<br/>大奖、美女、游戏爽不停~</h3>')
                        ._('</section>')
                        ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-thanks-btn-close" data-collect-desc="弹层(谢谢参与)-关闭按钮"><img src="./images/lottery-back.png"></a>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
            }
        ...
        openGift: {
            ...
            event: function() {
                ...
                this.$dialog.find('.gift-fight').click(function(e) {
                    e.preventDefault();
                    if ($(this).hasClass("flag")) {
                        return
                    } else {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="lh-dialog">')
                    ...
                    ._('<a class="gift-fight btn-active" data-collect="true" data-collect-flag="now-lottery" data-collect-desc="立即抽奖"><img src="./images/to-lottery.jpg" alt="" /></a>')
                    ._('</div>')
                ._('</section>');
                return t.toString();
            }
    ...
    W.presize = function(that) {
        $(that).css("height", $(that).closest(".dialog-content").height())
    };
