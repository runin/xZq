(function (W) {
   ...
   //openid = 45945454;
    ...
    var mpAuthRedirect = domain_url + "api/mp/auth/snsapi_userinfo";
    var holdfunAuthRedirect = domain_url + "api/mp/auth/snsapi_base";
    var params = null;
    ...
    */
    ...
    var holdfunAuthRun = function () {
        location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9097d74006e67df3&redirect_uri="
                      ...
                      + "&response_type=code&scope=snsapi_base&state=" + W.serviceNo + "#wechat_redirect";
    };
    /**
    * END OF 新掌趣授权
    */
    ...
    */
    ...
    var mpAuthRun = function () {
        location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + W.mpappid + "&redirect_uri="
                      + encodeURIComponent(mpAuthRedirect + "?callBackPage=&param=" + params + "&referer=" + location.href)
                      + "&response_type=code&scope=snsapi_userinfo&state=" + W.serviceNo + "#wechat_redirect";
