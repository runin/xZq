+(function () {
    var lottery = {
        ...
        initEvent: function () {
            ...
            //兑换类型
            //H.yao.luckCallback({ cc: "004KYKQEH7", result: true, tt: "恭喜你中天天淘金", ru: "http://baidu.com", pt: 5, pi: "http://cdn.holdfun.cn/lottery/prize/images/20151216/e309cf574dd1498e841c88e99bd3fff4.jpg" });
            //实物
            //H.yao.luckCallback({ result: true, tt: "实物一瓶酒", ru: "http://baidu.com", pt: 1, pi: "http://cdn.holdfun.cn/lottery/prize/images/20151216/e309cf574dd1498e841c88e99bd3fff4.jpg" });
            //shakeOccur();
        },
...
+(function () { //不中奖的时候的动画
    var n = $(".noget");
    window.noget = function () {
        n.removeClass("none").removeClass("noget_an");
        n.addClass("noget_an");
    }
    n.get(0).addEventListener("webkitAnimationEnd", function () { //动画结束时事件 
        setTimeout(function () {
            n.addClass("none");
        }, 700);
    }, false);
...
+(function () { //预加载图片
    var img = new Image();
    img.src = "images/lingqu.png";
    var img2 = new Image();
    img2.src = "images/lijiuserbtn.png";
})();
