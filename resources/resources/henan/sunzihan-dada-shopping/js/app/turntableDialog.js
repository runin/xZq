        ...
        redbagLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<legend class="tlt"><img src="images/turntable-win-prize.png" /></legend>')
        ...
        jfLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="jf-dialog">')
                    ...
                    ._('<img class="award-img" src="">')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-jfbag-btn-jfLottery-use" data-collect-desc="弹层(积分)-领取红包按钮">立即领取</a>')
                    ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                    ._('</section>')
        ...
        linkLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ...
                    ._('<img src="images/turntable-win-prize.png" />')
                    /*._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                     ._('<p class="award-keyTips"></p>')*/
                    ._('<img class="award-img" src="">')
                    ._('<section class="btn-lottery-box">')
