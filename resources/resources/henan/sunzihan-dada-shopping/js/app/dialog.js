(function($) {
    H.dialog = {
        ...
        rule: {
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    ...
                    'top': Math.round((height-320)/2)+'px'
                });
            },
            close: function () {
                var me = this;
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    ...
                    $(".dialog").css({
                        ...
                        'height': "380px",
                        'left': Math.round((width-250)/2)+'px',
                        'top': Math.round((height-380)/1.3)+'px'
                    });
                }
            },
            close: function() {
                ...
                t._('<section class="modal modal-redbag" id="redbag-dialog">')
                    ...
                    ._('<fieldset class="dialog-content">')
                            ...
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(红包)-领取红包按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</fieldset>')
                    ._('</section>')
                ._('</section>');
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'height': "400px",
                        'left': Math.round((width-250)/2)+'px',
                        'top': Math.round((height-400)/1)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "250px",
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-redbag" id="jf-dialog">')
                    ._('<section class="dialog redbag-dialog" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(积分)-立即领取按钮">')
                        ...
                        ._('<div class="tlt"><img src="images/win-prize.png" /></div>')
                        ._('<div class="dialog-content">')
                            /*._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                             ._('<p class="award-keyTips"></p>')*/
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-redbagLottery-use" data-collect="true" data-collect-flag="dialog-jf-btn-jfLottery-use" data-collect-desc="弹层(积分)-领取积分按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</div>')
                        ._('</section>')
                    ._('</section>')
        ...
        shiwuLottery: {
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    if(data.cu){
                        $("#shiwu-dialog").find(".qq").removeClass("none");
                    }else{
                        ...
                        $("#shiwu-dialog").find(".qq").val(data.qq ? data.qq : '');
                        $("#shiwu-dialog").find(".item").removeClass("none");
                    }
                }
            },
            check: function(data) {
                    ...
                    ._('<div class="dialog-content">')
                            ...
                            ._('<section class="footer">')
                                ._('<section class="input-box">')
                                    ._('<p><input class="name item none" type="text" id="name" placeholder="姓名"></p>')
                                    ._('<p><input class="phone item none" type="tel" id="phone" placeholder="电话"></p>')
                                    ._('<p><input class="address item none" type="text" id="address" placeholder="地址"></p>')
                                    ._('<p><input class="qq none" type="text" id="qq" placeholder="QQ"></p>')
                                ._('</section>')
                            ._('</section>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ...
                    ._('<div class="dialog-content">')
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
        ...
        duiHuanMaLottery: {
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    if(data.cc){
                        $("#dhm-dialog").find("#cc").text(data.cc).removeClass("none");
                    }
                    ...
                    ._('<section class="dialog dhm-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            /*._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                             ._('<p class="award-keyTips"></p>')*/
                            ._('<img class="award-img" src="">')
                            ._('<h2 class="none" id="cc"></h2>')
                            ._('<h2 class="copy">请复制或截图保存以便方便兑奖</h2>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-djmLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(兑换码)-领取兑换码按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
                ...
                t._('<section class="modal modal-wxcard" id="wxcard-dialog">')
                    ._('<section class="dialog wxcard-dialog">')
                        ...
                        ._('<fieldset class="dialog-content">')
                            ...
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-wxcardLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-wxcardLottery-award" data-collect-desc="弹层(卡券)-领取按钮"><img src="images/btn-award.png"/></a>')
                            ._('</section>')
                        ._('</fieldset>')
                    ._('</section>')
                ._('</section>');
        ...
        flowLottery: {
            ...
            tpl: function() {
                var t = simpleTpl();
                t._('<section class="modal modal-redbag" id="flow-dialog">')
                    ._('<section class="dialog redbag-dialog" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(流量红包)-立即领取按钮">')
                    ._('<a href="javascript:void(0);" class="btn-dialog-close" id="btn-dialog-close" data-collect="true" data-collect-flag="dialog-redbag-btn-close" data-collect-desc="弹层(流量红包)-关闭按钮"></a>')
                    ._('<div class="tlt"><img src="images/win-prize.png" /></div>')
                    ._('<div class="dialog-content">')
                    /*._('<p class="award-luckTips"><img src="./images/icon-luckytips.png"></p>')
                     ._('<p class="award-keyTips"></p>')*/
                    ._('<img class="award-img" src="" data-collect="true" data-collect-flag="dialog-jf-btn-jfLottery-use" data-collect-desc="弹层(流量红包)-领取积分按钮">')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get none" id="btn-flowLottery-use"><img src="images/btn-award.png"/></a>')
                    ._('</section>')
                    ._('</div>')
                    ._('</section>')
                    ._('</section>')
        ...
        thanks: {
            ...
            open: function(data) {
                ...
                this.pre_dom();
                if(data && data.pt == 0 && data.pi != ''){
                    $(".icon-thanks").attr("src",data.pi).attr("onerror", "$(this).addClass(\'none\')");
                }
            },
            pre_dom: function(){
                var width = $(window).width(),
                ...
                if(W.screen.width === 320){
                    ...
                    $(".dialog").css({
                        ...
                        'height': "380px",
                        'left': Math.round((width-250)/2)+'px',
                        'top': Math.round((height-400)/1.3)+'px'
                    });
                }
                /*if(W.screen.width === 320){
                    $(".dialog").css({
