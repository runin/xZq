(function($) {
	H.lottery = {
		...
		event: function() {
            ...
            $('body').delegate('.lottery-back', 'click', function(e) {
                e.preventDefault();
        ...
        count_down: function() {
            ...
            $('.detail-countdown').each(function() {
                $(this).countDown({
                    etpl: '<span>%H%' + '</span>时' + '<span>%M%</span>' + '分' + '<span>%S%</span>' + '秒', // 还有...结束
                    stpl: '<span>%H%' + '</span>时' + '<span>%M%</span>' + '分' + '<span>%S%</span>' + '秒', // 还有...开始
                    sdtpl: '',
                    otpl: '',
                    otCallback: function() {
                        if(me.canJump){
        ...
        allRecord_port: function(){
            getResult('api/lottery/allrecord', {at:1}, 'callbackLotteryAllRecordHandler');
        },
