(function($) {
    H.vote = {
        ...
        event: function(){
            ...
            var dm = document.querySelector('#dm-jt');
            dm.addEventListener('touchstart', function (e) {
                e.preventDefault();
                $('#dm-jt').addClass("lc-line");
                $("#fix").addClass("none");
                $(".go-vote").css('opacity', 1);
                setTimeout(function(){
                    $('#dm-jt').removeClass("lc-line");

                    $("#dm-section").removeClass("none").addClass("dm-show");
                    setTimeout(function(){
                        $("#dm-section").removeClass("dm-show");
                    },1000);
                    $(".go-dm").css('opacity', 0);
            ...
            var vote = document.querySelector('#vote-jt');
            vote.addEventListener('touchstart', function (e) {
                e.preventDefault();
                $('#vote-jt').addClass("bd-line");
                $("#fix").removeClass("none");
                $(".go-vote").css('opacity', 0);
                setTimeout(function(){
                    $('#vote-jt').removeClass("bd-line");
                    $("#dm-section").animate({'opacity':'0'}, 1000);
                    setTimeout(function(){
                        $("#dm-section").addClass("none").css('opacity', 1);
                    },1000);
                    $(".go-dm").css('opacity', 1);
                    $("body").removeClass("no-scroll");
                },300)
            });
            /*me.$vote_info.delegate('a.tped', 'click', function(e) {
                e.preventDefault();
                me.btn_animate($(this));
                showTips("抱歉！已经投过票了~~");
            });*/
