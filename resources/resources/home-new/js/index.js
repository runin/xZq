...
(function($) {
    H.index = {
        ...
        event: function(){
            ...
            $(".sense-dh .item-s.item-s1").click(function(){
                W.location.href = "yaotv.html";
            });
            $(".sense-dh .item-s.item-s2").click(function(){
                W.location.href = "periphery.html";
            });
