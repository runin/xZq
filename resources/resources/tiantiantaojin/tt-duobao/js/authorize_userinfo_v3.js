...
;(function(w) {
    ...
    Authorize.prototype.authorize = function(fn) {
        ...
        window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + this.mpappid + "&redirect_uri=" + encodeURIComponent(this.redirect_uri) + "&response_type=code&scope=" + this.scope + "&state=" + serviceNo3 + "#wechat_redirect";
        if (fn) {
            fn();
        }
    };
    ...
    var callBackPageUrl = "reduserguideqt.html";
