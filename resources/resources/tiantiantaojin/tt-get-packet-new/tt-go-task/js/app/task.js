    ...
    H.task = {
            ...
            update:function(data)
            {
                ...
                for(i = 0; i < length; i++)
                {
                    ...
                    ._(' <a href="'+ data[i].taskUrl + '" data-collect="true" class='+ task_class + ' id="go-task" data-collect-flag="tt-go-task" data-collect-desc="天天淘金-做任务"  data-taskId="' + data[i].taskId + '">立即参与</a>')
                    ._('</div>')
                    ._('</li>');
                }
