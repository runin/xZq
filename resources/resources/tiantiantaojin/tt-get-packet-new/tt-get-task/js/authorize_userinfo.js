; (function (w) {
    ...
    w.openid = Math.random()*10 + "222sdfs";//$.fn.cookie(mpappid + '_openid');
    ...
    Authorize.prototype.authorize = function (fn) {
      window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + this.mpappid + "&redirect_uri=" + encodeURIComponent(this.redirect_uri+"?authAppId="+this.mpappid+"&busiAppId="+busiAppId)+ "&response_type=code&scope=" + this.scope +  "&state="+state+"#wechat_redirect";
      if(fn){
         fn();
      }
    };
