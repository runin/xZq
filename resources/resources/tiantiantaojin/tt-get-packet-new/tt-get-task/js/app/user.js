            ...
            userPersonalInformation:
                {
                    ...
                    event:function()
                    {
                        ...
                        // //性别选择
                        // $('.sex-pop-content li').each(function(e)
                        // {
                        //     $(this).click(function(e)
                        //     {
                        //         var me = this;
                        //         $('.sex').val($(this).text());
                        //         $(this).addClass('sex-select');
                
                        //         setTimeout(function()
                        //         { 
                        //            $(me).removeClass('sex-select');
                        //            $('.sex-pop-dialog').addClass('none');
                        //         },500);
                                
                        //     });
                        // });
                        // $("p.pop-sex").on("click",function(e)
                        // {
                        //    $('.sex-pop-dialog').removeClass('none');
                        // });
                        // //性别取消
                        // $(".sex-pop-cancel").on("click",function(e)
                        // {
                        //    $('.sex-pop-dialog').addClass('none');
                        // });
                    },
