(function($) {
    H.newactive = {
        ...
        getDuobaoUrl:function()
        {
            getResult("redpack/lastResourceUrl",{appId:busiAppId,resourceType:"16"},"callbackLastResourceUrlHandler");
        },
        //错误处理
        ...
        event: function() {
            ...
            $("#gift-ok").click(function(e) {
                e.preventDefault();
                window.location.href = "https://ncfb.pingan.com.cn/ncfb/mobile/dm/weixin/cwyy.html?WT.mc_id=cfb-sxws-self-101";
            });
        },
        //用户日志
        userlog: function() {
    ...
    W.callbackLastResourceUrlHandler = function()
    {
