		...
		rule: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-rul" id="rule-dialog">')
					._('<div class="dialog rule-dialog" style="background-repeat:no-repeat!important;margin-top:20%;width:300px!important;height:180px!important;background:url(./images/rockpacket/activepopup.png);background-size:100% 100%!important;">')
					._('<h2 style="color:#fff!important;width:100%;">活动说明</h2>')
                    ._('<span style="position:absolute;right:26px;color:black!important;margin-top:-14%;font-size:1em;" class="close" >X</span>')
					._('<div class="rule-con" style="width:88%;padding-left:5%;margin-top:10px;">')
                    ._('<span style="color:#fff!important;" ></span>')
                    ._('</div>')
					._('</div>')
					._('</section>');
				return t.toString();
