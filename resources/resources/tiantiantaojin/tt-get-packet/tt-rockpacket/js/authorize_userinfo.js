; (function (w) {
    ...
    w.openid = "323"//$.fn.cookie(mpappid + '_openid');
   // w.openid =new Date().getTime();
    ...
    Authorize.prototype.authorize = function (fn) {
       window.location.href = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + this.mpappid + "&redirect_uri=" + encodeURIComponent(this.redirect_uri+"?authAppId="+this.mpappid+"&busiAppId="+busiAppId)+ "&response_type=code&scope=" + this.scope +  "&state=6#wechat_redirect";
      if(fn){
        fn();
      }
    };
