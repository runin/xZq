    ...
    H.dialog = {
                    ...
                    if(me.check()) {
                        if(!$('#btn-userinfo-submit').hasClass("flag")){
                            ...
                            $.ajax({
                                type: 'GET',
                                async: false,
                                url: domain_url + 'api/user/edit' + dev,
                                data: {
                                    oi: openid,
                                    tk: me.tk,
        ...
        redbagLottery: {
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    //$("#redbag-dialog").find("h3").html("现金红包"+((data.pv / 100) || '') +"元");
                    //$("#redbag-dialog").css("");
                }
            },
            tpl: function() {
                        ...
                        ._('<section class="dialog-content">')
                            ...
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    //._('<p style="color: #000000;font-weight: bolder;font-size: 18px;line-height: 40px">请在公众号推送消息中领取</p>')
        ...
        shiwuLottery: {
                ...
                this.$dialog.find('#btn-shiwuLottery-award').click(function(e) {
                    ...
                    if(me.check()){
                        if(!$('#btn-shiwuLottery-award').hasClass("flag")){
                            me.$dialog.find('#btn-shiwuLottery-award').off();
                            ...
                            $(".lot-in-bg>p>input").attr("disabled","disabled").css({"background-color":'transparent',"color":"white"});
                            me.$dialog.find('.btn-lottery').html("传递好运");
                            me.$dialog.find('.award-normalTips').addClass('none');
                            me.$dialog.find('.award-mid-img').removeClass('none');
                            setTimeout(function () {
                                $('#btn-shiwuLottery-award').css({"-webkit-animation":"jump 1s","animation-timing-function":"ease-out","-webkit-animation-timing-function":"ease-out"}).one("webkitAnimationEnd", function () {
                                    $('#btn-shiwuLottery-award').css({"-webkit-animation":""});
                                });
                            },200);

                            me.$dialog.find('#btn-shiwuLottery-award').click(function(e) {
                                e.preventDefault();
                                me.close();
                                H.dialog.shareLuck.open();
                            });
                        }
                    }
                });
            ...
            update: function(data) {
                var me = this;
                if(data.result){
                    $("#shiwu-dialog").find(".award-img").attr("src", "images/lot-top-bg.png").attr("onerror", "$(this).addClass(\'none\')");
                    ...
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<section class="dialog-body">')
                                ...
                                ._('<img class="award-mid-img none" src="./images/lot-mid-bg.png">')
                                ._('<p class="award-normalTips">获奖信息确认</p>')
                            ._('</section>')
                            ._('<section class="dialog-footer">')
                                ._('<section class="btn-lottery-box">')
                                    ._('<div class="lot-in-bg">')
                                        ._('<p style="font-size: 14px;text-align: center;color: white;height: 20px;line-height: 20px">您获得的奖品是</p>')
                                        ._('<p class="award-keyTips"></p>')
                                        ._('<p style="font-size: 14px;text-align: center;color: white;height: 20px;line-height: 20px">身份信息填写</p>')
                                    ...
                                    ._('</div>')
                                    ._('<a href="javascript:void(0);" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">确认信息</a>')
                                ._('</section>')
                            ._('</section>')
                        ._('</section>')
                    ._('</section>')
        ...
        jifenLottery: {
                ...
                this.$dialog.find('#btn-jifenLottery-award').click(function(e) {
                    ...
                    if(me.check()){
                        if(!$('#btn-jifenLottery-award').hasClass("flag")){
                            me.$dialog.find('#btn-jifenLottery-award').off();
                            ...
                            me.$dialog.find('.award-mid-img').removeClass('none');
                            setTimeout(function () {
                                $('#btn-jifenLottery-award').css({"-webkit-animation":"jump 1s","animation-timing-function":"ease-out","-webkit-animation-timing-function":"ease-out"}).one("webkitAnimationEnd", function () {
                                    $('#btn-jifenLottery-award').css({"-webkit-animation":""});
                                });
                            },200);

                            me.$dialog.find('#btn-jifenLottery-award').click(function(e) {
                                e.preventDefault();
                                me.close();
                                H.dialog.shareLuck.open();
                            });
            ...
            update: function(data) {
                var me = this;
                if(data.result){
                    $("#jifen-dialog").find(".award-img").attr("src", "images/lot-top-bg.png").attr("onerror", "$(this).addClass(\'none\')");
                    $("#jifen-dialog").find(".award-keyTips").html(data.pn || '');
                    $("#jifen-dialog").find('.name').val(data.rn || '');
                    $("#jifen-dialog").find('.mobile').val(data.ph || '');
                    $("#jifen-dialog").find('.address').val(data.ad || '');
                }
            },
            check: function() {
                var me = this, $mobile = me.$dialog.find('.mobile'),
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-jifen" id="jifen-dialog">')
                    ...
                    //._('<p><input type="text" class="address" placeholder="地址" /></p>')
                    ._('</div>')
                    ._('<a href="javascript:void(0);" class="btn-lottery btn-jifen-lottery-award" id="btn-jifenLottery-award" data-collect="true" data-collect-flag="dialog-jifen-btn-shiwuLottery-award" data-collect-desc="弹层(积分)-领取按钮">确认信息</a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
        ...
        codeLottery: {
            ...
            update: function(data) {
                ...
                if(data.result){
                    ...
                    $("#code-dialog").find(".award-keyTips").html(data.pn || '');
                    if (data.cc || data.cc != '') {
                        if (data.cc.split(',')[0]) {
        ...
        shareLuck: {
            ...
            open: function() {
                ...
                $(".modal:after").css("background","url(../images/lot-share-bg.jpg) no-repeat top center");
            },
            close: function() {
                var me = this;
                this.$dialog.find('.dialog').removeClass('bounceInDown').addClass('bounceOutDown');
            ...
            tpl: function() {
                var t = simpleTpl();
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<img style="position:absolute;z-index:999;width:100%;height:100%;top: 0" src="images/lot-share-bg.jpg">')
                    ._('<section class="dialog shiwu-dialog">')
                    ._('<section class="dialog-content">')
                    ._('<section class="dialog-body">')
                    ._('</section>')
                    ._('<section class="dialog-footer">')
                    ._('<section class="btn-lottery-box">')
                    ._('<a href="javascript:void(0);" style="margin: 135% auto" class="btn-lottery btn-shiwu-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-shiwu-btn-shiwuLottery-award" data-collect-desc="弹层-继续摇奖">继续摇奖</a>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
                    ._('</section>')
