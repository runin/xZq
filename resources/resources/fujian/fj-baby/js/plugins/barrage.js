...
; (function () {
    ...
    $.fn.barrage = function (opts) {
        var setting = {
            fontSize: [16, 18, 24],
            fontColor: ["ff0072", "1686ef", "ff8400"],
            padding: 10,
            heightOffset: 10,
            itemHeight: 26,
            leftRange: 80,
        ...
        this.appendMsg = function (msg) {
            ...
            arr.push("-webkit-animation-timing-function: ease-in;");
            arr.push("-webkit-animation-iteration-count: 1;");
            arr.push("}");
            arr.push(" @-webkit-keyframes " + className + "_a {");
            arr.push(" 100% {");
            arr.push(" -webkit-transform:translateX(" + (0 - msgWidth - 100) + "px);");
            arr.push(" }");
            arr.push("}");
