(function($) {
	H.dialog = {
        ...
        kjLottery: {
            ...
            pre_dom: function(){
                ...
                $(".dialog").css({
                    'width': width * 0.9,
                    'height': height * 0.6,
                    'left': Math.round((width*0.1)/2)+'px',
                    'top': Math.round((height*0.4)/2)+'px'
                });
            },
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".btn-award").height() + (height * 0.26);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
                    innerheight = 80 +$(".btn-award").height() + (height * 0.15);
                }
                $(".dialog").css({
                    'height': innerheight,
        ...
        swLottery: {
            ...
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".award-win>.contact").height() + (height * 0.22);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
        ...
        jfLottery: {
            ...
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".award-win>.contact").height() + (height * 0.26);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
                    innerheight = 80 +$(".contact").height() + (height * 0.15);
                }
        ...
        wlLottery: {
            ...
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".btn-award").height() + (height * 0.22);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
                    innerheight = 80 +$(".contact").height() + (height * 0.15);
                }
        ...
        dhLottery:{
            ...
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".award-win>.contact").height() + $(".tt").height()+ (height * 0.28);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
                    innerheight = 80 +$(".contact").height() + (height * 0.2);
                }
                $(".dialog").css({
                    'height': innerheight,
                    'top': Math.round((height - innerheight)/2)+'px'
