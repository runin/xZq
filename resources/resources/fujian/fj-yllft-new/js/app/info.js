(function($){
    H.record = {
        ...
        event: function(){
            ...
            $('.info-btn-back').click(function(e) {
                e.preventDefault();
                toUrl('yao.html');
            });
            ...
            for (var i = 0; i < len; i ++) {
                ...
                if (items[i].cc) {
                    if (items[i].cc.split(',')[0]) {
                        t._('<div class="gift-numb">' + items[i].cc.split(',')[0] + '</div>')
                        t._('</div>');
                    }
                }
                t._('</div>')
            ...
            for (var i = 0; i < len; i ++) {
                t._('<li>')
                  ._('<section>')
                    ...
                    ._('<img src="images/icon-goldcoin.png">')
                    ._('<p>' + (items[i].nn || '匿名用户') + '</p>')
                  ._('</section>')
                  ._('<section><img src="images/icon-coin.png"><p>' + (items[i].in || '') + '</p></section>')
                ._('</li>')
            };
