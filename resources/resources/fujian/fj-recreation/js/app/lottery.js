    ...
    H.lottery = {
        ...
        event: function() {
            ...
            $("#btn-back").click(function(e){
                e.preventDefault();
                me.btn_animate($(this));
                if(getQueryString("markJump") == "detailsClick"){
                    toUrl("details.html?markJump=yaoClick&periodUuid="+ me.periodUuid +"&guid="+ me.guid +"&pid="+ me.pid);
                }else{
                    toUrl("vote.html?markJump=yaoClick");
                }
