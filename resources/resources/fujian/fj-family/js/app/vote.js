                        ...
                        for(var i = 0;(i<=data.items.length - 1);i++){
                            ...
                            if((serverT>st)&&(serverT<et)){
                                ...
                                for(var a = 0; a < data.items[i].pitems.length;a++){
                                    ...
                                    var infoData = "";
                                    infoData += '<div class="zan" id="' + data.items[i].pitems[a].pid + '"><div class="voteinfo"></div>';
                                    ...
                                    infoData += '<div class="zan-bg"><img class="baby" id="baby" src="' + H.vote.pic + '" /></div><img class="zand" id="zand" src="images/zand-bg.png" />';
                                    infoData += '<div class="zan-per"><span></span><img src="images/starts.png" /><div><p></p></div></div>';
