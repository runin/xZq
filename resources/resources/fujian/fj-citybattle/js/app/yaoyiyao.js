            ...
            switch(winners)
            {
                case 4://红包中奖
                     N.showPage("yao-gift",function(){
                    	 ...
                    	 recordUserPage(openid, "福建都市城市保卫战红包领奖页", 'tv-fjdushi-citybattle-redbag');
          						 that.audioStop()//关闭摇声音
          						 that.audioZj();//中奖声音
                    	 that.redHongbao.find(".gift-hongbao-img").attr('src', (data.pi || ''));
                       that.redHongbao.find(".award-tips").html(data.tt || '恭喜您获得红包~');
                ...
                case 5://兑换码奖品
                     N.showPage("yao-gift",function(){
                       ...
                       recordUserPage(openid, "福建都市城市保卫战兑换码领奖页", 'tv-fjdushi-citybattle-code');
                       isCanShake = false;
                       that.audioStop()//关闭摇声音
                       that.audioZj();//中奖声音
    ...
    H.yao = {
            ...
            shake_listener: function() {
              ...
              if(!$("#yao-redbao").hasClass("none")) {
                recordUserOperate(openid, "福建都市城市保卫战摇一摇", "tv-fjdushi-citybattle-shake");
                times++;
