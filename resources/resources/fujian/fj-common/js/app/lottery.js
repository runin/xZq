(function($) {
    H.lottery = {
        ...
        event: function() {
            ...
            $("#grzx").tap(function(e){
                e.preventDefault();
                me.btn_animate($(this));
                toUrl("user.html?pu="+H.lottery.sau);
            });
        ...
        imgMath: function() {//随机背景
            ...
            if(me.lotteryImgList.length >0){
                ...
                $("body").css({
                    "backgroundImage":"url('"+me.lotteryImgList[i]+"')",
    ...
    W.callbackArticledetailListHandler = function(data){
        if(data.code == 0){
            $(".main-top").css({
                "background": "url("+ data.arts[1].img +")no-repeat bottom center",
                "background-size": "cover"
            });
            H.lottery.sau =data.arts[0].uid;
        }
    }
})(Zepto);
