(function($) {
	H.dialog = {
        ...
        redLottery: {
            ...
            resize: function () {
                var height = $(window).height();
                var innerheight = $(".pi").height() +$(".btn-award").height() + $(".tt").height() + ($(window).height()*0.25);
                if(innerheight > (height * 0.9)){
                    $(".pi").css("height","80px");
                    innerheight = 90 +$(".btn-award").height() + $(".tt").height() + $(".btn-award").height() + ($(window).height()*0.25);
                }
                $(".dialog").css({
                    'height': innerheight,
                    'top': Math.round((height - innerheight)/2)+'px'
            ...
            update: function(data) {
                ...
                if(data){
                    if (data.result) {
                        ...
                        this.$dialog.find('.pv').html((data.pv * 0.01)+"元" || '');
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="lottery-dialog">')
                    ...
                    ._('<h2 class="tt"></h2>')
                    ._('<h3 class="pv"></h2>')
                    ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="fj-ydsBzq-lotterydialog-know-btn" data-collect-desc="抽奖弹层-我知道了按钮">领取</a>')
                    ._('</div>')
