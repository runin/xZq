; (function (w, $) { 
   ...
   /***********游戏对象***********/
   {
	...
	debugger;
       this.popIcon = PIXI.Texture.fromImage('./images/icon-pop.png');
    ...
    Game.prototype.setEachCorpsNum =function(that){//根据最大分值计算每个物体的数量
          this.noCloud ={ name:"noCloud", count:1,url:"images/icon-pop-small.png",rotation:0.01,speed:4,score:1,percent:0.4,setCount:function(){ this.count = Math.ceil(that.maxScore*this.percent/this.score) } };//没有表情的云
          this.bigCloud={ name:"bigCloud", count:1,url:"images/icon-pop-middle2.png",rotation:0.01,speed:5,score:5 ,percent:0.3,setCount:function(){ this.count = Math.ceil(that.maxScore*this.percent/this.score)}};//大云
          this.smallCloud={ name:"smallCloud", count:1,url:"images/icon-pop-middle.png",rotation:0.01,speed:6,score:5,percent:0.2,setCount:function(){ this.count = Math.ceil(that.maxScore*this.percent/this.score) }};//小云
          this.mcCloud ={ name:"mcCloud", count:1,url:"images/icon-pop-mc.png",rotation:0.01,speed:7,score:10 ,percent:0.1,setCount:function(){ this.count = Math.ceil(that.maxScore*this.percent/this.score)}};//mc 云
		  ...
		  this.noCloud.setCount();
		  this.bigCloud.setCount();
		  this.smallCloud.setCount();
	      this.mcCloud.setCount();
          this.boom.setCount();
	...
	Game.prototype.fenshu = function() {//分数重置
			this.downText.text = "00分";
	};
    ...
    Game.prototype.downCountFn = function(){
              ...
              var d_bg = PIXI.Texture.fromImage('images/bg_contain.png');
              ...
              this.downText = new PIXI.Text("0"+this.score + "分");
              this.downText.style.align ="center";
              this.downText.width=90;
              this.downText.height =40;
              this.downText.scale.set(0.7);
              this.downText.position.x = $(window).width()-  58;
              this.downText.position.y = 34;
       ...
       function Corps(that){
         ...
         corpsItem.prototype.setSpecialEffects =function(fn){//爆炸特效
            ...
            for(var i=0,len=30;i<len;i++){
              var item = new corpsItem(that,that.noCloud.url,that.smallCloud,true);
   ...
   /***********爆米花桶***********/
   {
      function Bucket(that){
           var this_Bucket =this;
                ...
                if(PIXI.loader.resources['images/icon-bag.png']){
                  PIXI.loader.resources['images/icon-bag.png']=null;
                }
