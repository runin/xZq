;(function($) {
	...
	H.win = {
		...
		collect: function(score){
			...
			var lenght = H.index.awardList.length;
			awardIndex = Math.random() * H.index.awardList.length;
			awardIndex = Math.floor(awardIndex);
	...
	H.record = {
		...
		fillList: function(data){
			...
			if(data && data.result == true) {
				...
				t._('<li class="placehoder"><p class="record-code">暂无中奖纪录哦</p></li>')
	    		this.$list.html(t.toString());
			}
		},
