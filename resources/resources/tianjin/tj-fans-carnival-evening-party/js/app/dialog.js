    ...
    H.dialog = {
        ...
        shiwuLottery: {
            ...
            pre_dom: function(){
                ...
                if(W.screen.width === 320){
                    $(".dialog").css({
                        ...
                        'height': "254px",
                        'left': Math.round((width-250)/2)+'px',
                        'top': Math.round((height-254)/2)+'px'
                    });
                }else{
                    $(".dialog").css({
                        'width': "300px",
                        ...
                        'top': Math.round((height-305)/2)+'px'
                    });
                }
            },
            close: function() {
            ...
            event: function(data) {
                ...
                this.$dialog.find('.btn-wxcard-lottery-award').click(function(e) {
                    e.preventDefault();
                    $(this).addClass("none");
                    $(".before").addClass("none");
                    $('.footer').removeClass("none");
                    $('.btn-wxcard-lottery-submit').removeClass("none");

                });

                this.$dialog.find('.btn-wxcard-lottery-submit').click(function(e) {
                    e.preventDefault();
                    H.dialog.btn_animate($(this));
                    if(me.check(data)) {
                        if(!$(this).hasClass("flag")){
                            ...
                            me.close();
                            W.localStorage.setItem("luckData", JSON.stringify(data));
                            toUrl("successfully.html");
                            /*if(me.isFocus && !is_android()){
                                toUrl("lottery.html");
                            }*/
                        }
                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<section class="dialog-content">')
                            ._('<p class="award-keyTips before"></p>')
                            ._('<img class="award-img before" src="">')
                            ._('<section class="footer none">')
                                ._('<h1>（填写信息，即可完成领取）</h1>')
                            ...
                            ._('</section>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-wxcard-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">点击领取</a>')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-submit none" id="btn-shiwuLottery-submit" data-collect="true" data-collect-flag="dialog-wxcard-btn-shiwuLottery-submit" data-collect-desc="弹层(实物)-提交按钮">提 交</a>')
                            ._('</section>')
                        ._('</fieldset>')
                    ._('</section>')
                ._('</section>');
                ...
                t._('<section class="modal modal-link" id="link-dialog">')
                    ._('<section class="dialog link-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            ...
                            ._('<img class="award-img" src="">')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-link-use" id="btn-linkLottery-use" data-collect="true" data-collect-flag="dialog-link-btn-linkLottery-use" data-collect-desc="弹层(外链)-立即领取按钮">点击领取</a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-link" id="dhm-dialog">')
                    ...
                    ._('<fieldset class="dialog-content">')
                        ...
                        ._('<section class="btn-lottery-box">')
                            ._('<a href="javascript:void(0);" class="btn-lottery btn-redbag-get" id="btn-djmLottery-use" data-collect="true" data-collect-flag="dialog-redbag-btn-redbagLottery-use" data-collect-desc="弹层(兑换码)-领取兑换码按钮">领 取</a>')
                        ._('</section>')
                    ._('</fieldset>')
                    ._('</section>')
                ._('</section>');
        ...
        thanks: {
            ...
            textMath: function() {//随机img
                ...
                if(thanks_imgs.length >0){
                    ...
                    if(i == 0){
                        recordUserOperate(openid, "星厨驾到二维码", "starChef");
                    }else{
