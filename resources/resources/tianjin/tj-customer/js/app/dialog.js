    ...
    H.dialog = {
		...
		rule: {
			...
			tpl: function () {
				...
				t._('<section class="modal modal-rul" id="rule-dialog">')
					._('<a href="#" class="btn-close close" data-collect="true" data-collect-flag="tj-customer-ruledialog-closebtn" data-collect-desc="天津315规则弹层-关闭按钮"></a>')
					._('<div class="dialog rule-dialog">')
					._('<h2>领奖规则</h2>')
					._('<div class="content">')
					._('<div class="rule-con"></div>')
					._('</div>')
					._('<p class="dialog-copyright"><a href="#" class="btn my-zhidao close" data-collect="true" data-collect-flag="tj-customer-guide-trybtn" data-collect-desc="天津315规则弹层-我知道了按钮">我知道了</a>本活动最终解释权归天津广播电视台所有</p>')
					._('</div>')
					._('</section>');
				return t.toString();
			}
            ...
            tpl: function() {
                var t = simpleTpl();
                	t._('<div class="modal">')
						...
						._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="tj-customer-succdialog-closebtn" data-collect-desc="爆料成功弹层-关闭按钮"></a>')
							//爆料提交成功
							._('<div class="not-lott" id="not-lott">')
								._('<img src="images/smile.png">')
								._('<h1>恭喜您，您已成功提交!</h1>')
								._('<a class="btn lottery-close back" data-collect="true" data-collect-flag="tj-customer-go-on-lottery" data-collect-desc="返回按钮">继续抽奖</a>')
							._('</div>')
        ...
        lottery: {
			...
			tpl: function() {
				...
				t._('<div class="modal" id="lottery-dialog">')
					._('<div class="dialog lottery-dialog">')
					._('<a href="#" class="btn-close lottery-close" data-collect="true" data-collect-flag="tj-customer-lottdialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
						//未中奖
						._('<div class="not-lott" id="not-lott">')
							._('<img src="images/sad.png">')
							._('<h1>很遗憾，您与奖品擦肩而过</h1>')
							._('<h1>请您继续关注节目，参与有奖互动！</h1>')
							._('<a class="btn lottery-close lott-back" data-collect="true" data-collect-flag="tj-customer-sharebtn" data-collect-desc="返回按钮">返 回</a>')
						._('</div>')
						//中奖
						._('<div class="lott none" id="lott">')
							...
							._('<a class="btn btn-share bth-aw btn-award" id="btn-award" data-collect="true" data-collect-flag="tj-customer-combtn" data-collect-desc="天津315-确定按钮">我知道了</a>')
        ...
        error: {
            ...
            tpl: function() {
                ...
                ._('</p>')
                ._('<a href="index.html" class="activities-btn btn-try" data-collect="true" data-collect-flag="tj-customer-podium-trybtn" data-collect-desc="关闭按钮">确定</a>')
                ._('</div>')
                ._('</section>');
                return r.toString();
            }
        ...
        showWin: {
            ...
            tpl: function () {
                if (!this.customTemp) {
                    ...
                    ._('</p>')
                    ._('<a href="javascript:void(0)" id="showWin-sure" class="activities-btn" data-collect="true" data-collect-flag="tj-customer-podium-trybtn" data-collect-desc="关闭按钮">确定</a>')
                    ._('</div>')
                    ._('</section>');
                    return b.toString()
                } else {
