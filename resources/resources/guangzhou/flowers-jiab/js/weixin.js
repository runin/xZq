;(function($){
    $.fn.wx = function(option){
        ...
        var _unit = {
            ...
            addOpenid: function(index) {
            	var url = this.getUrl(index);
            	if(url.indexOf("resopenid=") > 0){
            		url = this.replaceParamVal('resopenid', hex_md5(openid), index);
            	}else{
            ...
            replaceParamVal: function(paramName, replaceWith, index) {
                var oUrl = this.getUrl(index).toString();
            ...
            getUrl: function(index) {
            	...
            	if (index) {
            		href = href.substr(0, href.lastIndexOf('/') + 1) + 'index.html';
            	}
            	return href;
            }
        }
        ...
        var opt = {
            ...
            "img_width" : 180,
            "img_height" : 180,
            "link" : opts.url,	//_unit.addOpenid(true),
            "desc" : opts.desc,
            "title" : opts.title
        };
