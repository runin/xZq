...
var getUrl = function () {
	...
	if(href.indexOf("main.html") != -1) {
		var href = window.location.href.replace('main.html','index.html');
	}
	if(href.indexOf("card.html") != -1) {
		var href = window.location.href.replace('card.html','index.html');
	}
	if(href.indexOf("my.html") != -1) {
		var href = window.location.href.replace('my.html','index.html');
	}
	if(href.indexOf("lottery.html") != -1) {
		var href = window.location.href.replace('lottery.html','index.html');
	}
...
$(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var shareUrl = getUrl().replace(/comment|my_score/, "index");
