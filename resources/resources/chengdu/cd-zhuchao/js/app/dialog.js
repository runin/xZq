				...
				t._('<section class="modal" id="rule-modal">')
					._('<div class="dialog rule-dialog">')
						...
						._('<div class="dialog-assist">')
							._('<h1 class="rule-title"><img src="images/rule-title.png"/></h1>')
							...
							._('<div class="lottery-good lottery-card">')
							 ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="lottery-dialog-closebtn" data-collect-desc="领奖弹层-关闭按钮"></a>')
								._('<div class="lottery-assist">')
									._('<h1 class="lott-title"><img src="images/lott-title.png"/></h1>')
									._('<div class="line-assist">')
										._('<div class="award-img">')
											._('<img id="aw" src="" />')
										._('</div>')
										._('<div class="contact none">')
											._('<h4 class="award-tip">请填写您的联系方式，以便顺利领奖</h4>')
											._('<p class="q-name"><label>姓  名：</label><input type="text" class="name" placeholder="" /></p>')
											._('<p class="q-mobile"><label>电  话：</label><input type="tel" class="mobile" placeholder="" /></p>')
											._('<p class="q-address"><label>地  址：</label><input type="text" class="address" placeholder="" /></p>')
										._('</div>')
										._('<a href="#" class="btn-know btn-award none" id="btn-award" data-collect="true" data-collect-flag="lotterydialog-OKbtn" data-collect-desc="抽奖弹层-领取按钮">领取</a>')
										._('<a href="#" class="btn-know btn-back none" id="btn-back" data-collect="true" data-collect-flag="lotterydialog-OKbtn" data-collect-desc="抽奖弹层-返回按钮">确定</a>')
								    ._('</div>')
								._('</div>')
							._('</div>')
						._('</div>')
