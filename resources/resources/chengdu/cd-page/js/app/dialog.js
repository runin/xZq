(function($) {
        ...
        lottery: {
            ...
            update: function(data) {
                ...
                if (data.result && (data.pt == 7 || data.pt == 9)) {
                    me.pt = data.pt;
                    $(".lottery-dialog").find(".award-img").attr("src", data.pi).attr("onload","presize(this)");
                    if (data.cu == 1) {
            ...
            tpl: function() {
                ...
                t._('<div class="modal modal-lottery" id="lottery-dialog">')
                    ...
                    ._('<i class="lf-dingzi dingzi"></i>')
                    ._('<i class="rt-dingzi dingzi"></i>')
                    ._('<div class="top-bar">')
        ...
        Entlottery: {
            ...
            update: function(data) {
                ...
                if (data.result && data.pt == 5) {
                    ...
                    $("#Entlottery-dialog").find(".award-img").attr("src", data.pi).attr("onerror", "$(this).addClass(\'none\')").attr("onload","presize(this)");
            ...
            tpl: function() {
                ...
                ._('<img class="award-img" src="" >')
                    ...
                    ._('</div>')
                    ._('</div>')
                    ._('<a class="lottery-btn" id="btn-award" data-collect="true" data-collect-flag="dialog-task-Entlottery-award-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-提交信息按钮"">立  即  领    取</a>')
                    ._('<a class="lottery-btn none" id="btn-link" data-collect="true" data-collect-flag="dialog-task-Entlottery-award-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-提交信息按钮"">立  即  领    取</a>')
                    ._('<a class="lottery-btn none" id="btn-use" data-collect="true" data-collect-flag="dialog-task-Entlottery-award-btn" data-collect-desc="中奖弹层业务类(实物-兑换码)-提交信息按钮"">立  即  领    取</a>')
                    ._('</div>')
                    ._('</div>');
                return t.toString();
            },
        ...
        Redlottery: {
            ...
            update: function(data) {
                ...
                if (data.result && data.pt == 4) {
                    me.rp = data.rp;
                    $(".redlottery-dialog").find(".award-img").attr("src", data.pi).attr("onerror", "$(this).addClass(\'none\')").attr("onload","presize(this)");
            ...
            tpl: function() {
                ...
                t._('<div class="modal modal-lottery" id="Redlottery-dialog">')
                    ...
                    ._('</div>')
                    ._('<img class="award-img" src="">')
                    ._('<a class="lottery-btn" id="btn-red" data-collect="true" data-collect-flag="dialog-task-red-close-btn" data-collect-desc="中奖弹层业务类(红包)-领取按钮">立&nbsp;&nbsp;即&nbsp;&nbsp;领&nbsp;&nbsp;取</a>')
        ...
        Tellottery: {
            ...
            update: function(data) {
                ...
                if (data.result && data.pt == 6) {
                    $(".tellottery-dialog").find(".award-img").attr("src", data.pi).attr("onerror", "$(this).addClass(\'none\')").attr("onload","presize(this)");
    ...
    {
        $(that).css("height",$(that).closest(".dialog").height()-$(that).closest(".dialog").find(".top-bar").height()-15)
    };
