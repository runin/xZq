...
(function ($) {
    ...
    W.callbackLotteryRoundHandler = function (data) {
        ...
        /*data = {
            "result": true,
            "la": [{
                "ud": "aa3ba19a6d3e42e6a97f169726778f43",
                "pd": "2015-10-15",
                "st": "19:25:00",
                "et": "19:25:05",
                "nst": "2015-10-15 19:25:10",
                "lc": 100,
                "bi": "",
                "ui": 0
            }, {
                "ud": "8f37c03e75af4effbfec37898eec9fb0",
                "pd": "2015-10-15",
                "st": "19:25:10",
                "et": "19:25:15",
                "nst": "2015-10-16 19:25:20",
                "lc": 100,
                "bi": "",
                "ui": 0
            },{
                "ud": "8f37c03e75af4effbfec37898eec9fb1",
                "pd": "2015-10-15",
                "st": "19:25:20",
                "et": "19:25:25",
                "nst": "2015-10-18 19:21:31",
                "lc": 100,
                "bi": "",
                "ui": 0
            }],
...
(function ($) {
    ...
    H.yao = {
        ...
        luckCallback: function (data) {
            ...
            if (data.result == false) {
                ...
                $(".no-redpack").removeClass("none");
                setTimeout(function () {
                    $(".no-redpack").addClass("none");
                }, 1500);
                return;
            }
    ...
    W.shakeOccur = function () {
        //统计次数
        var lotteryUuid = H.router.roundData[H.router.currentRound].ud;
        var lotteryCount = $.fn.cookie("yao_rate_" + lotteryUuid);
        if (!lotteryCount) {
            lotteryCount = 0;
        }
        $.fn.cookie('yao_rate_' + lotteryUuid, ++lotteryCount, {expires: 1});
    ...
    W.callbackLotteryLuckHandler = function (data) {
        ...
        getResult("api/lottery/reportLotteryCount", {oi: openid, lu: lotteryUuid, lc: lotteryCount}, "W.callbackReportLotteryCountHandler");
        //showTips(lotteryUuid + "_____" + lotteryCount, 2, 1000);
    };

    W.callbackReportLotteryCountHandler = function (data) {
        if (data && data.result) {
    ...
    W.roundAllEnd = function () {
        ...
        H.countdown.$content.removeClass('none').html("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;摇奖活动已经结束");
