(function($) {
    H.dialog = {
        ...
        relocate: function() {
            ...
            $('.modal').each(function() {
                $(this).css({ 'width': width, 'height': height }).find('.btn-close').css({'right': width * 0.06 - 35, 'top': top - 42});
                    if(window.screen.width > 360 && window.screen.height < 750){
                        $(this).css({ 'width': width, 'height': height }).find('.btn-close').css({'right': width * 0.06 - 35, 'top': top - 52})
                    }
            });
        ...
        rule: {
            ...
            tpl: function() {
                ...
                ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="hlj-hreo-dn-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
        ...
        mytry: {
            ...
            tpl: function () {
                if (!this.customTemp) {
                    ...
                    ._('<div class="receive relocated bounceInDown">')
                    ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="hlj-hreo-dn-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
                    ._('<p class="safety-text">' + this.getText())
                    ._('</p>')
                    ._('<a href="javascript:void(0)" id="showWin-sure" class="activities-btn" data-collect="true" data-collect-flag="hlj-hreo-dn-podium-trybtn" data-collect-desc="关闭按钮">等一下去试试</a>')
                    ._('</div>')
                    ._('</section>');
                    return b.toString()
                } else {
