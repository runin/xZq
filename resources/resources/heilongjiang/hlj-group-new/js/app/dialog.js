(function($) {
    H.dialog = {
        ...
        relocate: function() {
            ...
            $('.modal').each(function() {
                $(this).css({ 'width': width, 'height': height }).find('.btn-close').css({'right': width * 0.06 - 35, 'top': top - 45})
            });
        ...
        mytry: {
            ...
            tpl: function () {
                if (!this.customTemp) {
                    ...
                    ._('</p>')
                    ._('<a href="javascript:void(0)" id="showWin-sure" class="activities-btn" data-collect="true" data-collect-flag="dn-podium-trybtn" data-collect-desc="关闭按钮">等一下去试试</a>')
                    ._('</div>')
                    ._('</section>');
                    return b.toString()
                } else {
