(function($) {
    H.yao = {
        ...
        first:true,
        isToLottey:true,
        lotteryTime: 2,//getRandomArbitrary(1,5),
        yaoBg: [],
        ...
        not_winning: function(data){
            ...
            }else if(data !== null && data.pt == 0){
                me.isCanShake = false;
                $(".none-award").removeClass('none').find(".none-cls").one("click", function () {
                    me.isCanShake = true;
                    $(".none-award").addClass('none');
                });
                if(H.yao.turn == false){
                    $(".AD1").addClass('none');
                    $(".AD2").removeClass('none');
                    $(".ct>p").html("华莱健安化黑茶陕西省总代理提醒您太遗憾啦，没中奖！继续加油！");
                    H.yao.turn = true;
                }else{
                    $(".AD1").removeClass('none');
                    $(".AD2").addClass('none');
                    $(".ct>p").html("陕西省城固酒业有限公司提醒您太遗憾啦，没中奖！继续加油！");
                    H.yao.turn = false;
                }
            }
        },
