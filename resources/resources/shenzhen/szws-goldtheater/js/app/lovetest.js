    ...
    H.question = {
        ...
        resultTpl: function() {
            ...
            t._('<li class="fadeInLeft">')
                ...
                ._('<div class="article fl">据说这是一扇致富大门，点击看看门后有什么吧！</div>')
                ._('</li>')
                ._('<li class="opacity">')
                ._('<a href="http://mp.weixin.qq.com/s?__biz=MzA3MjkyMDU2MQ==&mid=404154051&idx=4&sn=4e5581f1f921342de6521bdf546cfb59&scene=0#wechat_redirect" class="go-btn" data-collect="true" data-collect-flag="question-linebtn" data-collect-desc="测试页-线路按钮">现在就去GO</a>')
                ._('</li>');
            return t.toString();
