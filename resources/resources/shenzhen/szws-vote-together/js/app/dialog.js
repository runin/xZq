	...
	H.dialog = {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					._('<div class="dialog rule-dialog">')
						._('<a href="#" class="btn-close close" data-collect="true" data-collect-flag="rule-dialog-closebtn" data-collect-desc="规则弹层-关闭按钮"><img src="images/btn-rule-close.png"></a>')
		...
		thank: {
			...
			event: function() {
				...
				this.$dialog.find('.not-red-link').tap(function(e) {
					e.preventDefault();
					window.location.href = "http://activity.zhenrongbao.com/atv/register?contact_from=996_11";
				});
			},
			tpl: function() {
				var t = simpleTpl();
				t._('<section class="modal" id="thank-dialog">')
					._('<div class="dialog thank-dialog">')
						._('<div class="dialog-assist">')
							._('<a href="#" class="btn-close close" data-collect="true" data-collect-flag="thank-dialog-closebtn" data-collect-desc="未中奖弹层-关闭按钮"><img src="images/btn-close.png"/></a>')
							._('<h1 class="thank-title"><img src="images/not-congra.png"/></h1>')
							._('<div class="border">')
								._('<img src="images/erweima.jpg" />')
								._('<p>长按识别二维码，更多精彩等着你</p>')
							._('</div>')
							._('<img class="not-red-link" id="not-red-link" src="images/not-red-link.png" />')
						._('</div>')
					._('</div>')
				._('</section>');
				return t.toString();
