...
function blindevent() {
    ...
    document.getElementById("midlogo").onload = function() {
        setTimeout(function() {
            midlogo.css({
                ...
                btnin.css({
                    "opacity": "1",
                    "-webkit-animation": "rshow 2s",
                    "animation-timing-function": "linear",
                    '-webkit-animation-timing-function': 'ease-out'
                });
                $(".handsw").css({
                    "display": "block",
                    "-webkit-animation": "handswap 3s infinite",
                    "animation-timing-function": "ease-out",
                    "-webkit-animation-timing-function": "ease-out"
                });
            });
    ...
    toucha.on("touchstart", function(ts) {
        ...
        toucha.on("touchmove", function(e) {
            ...
            if (!isret) {
                btnin.css({
                    "width": ((winW * 0.05) + constx - x) + "px",
                    "height": ((winH * 0.05) + constx - x) + "px"
                });
