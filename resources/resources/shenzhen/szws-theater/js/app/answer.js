(function($) {
    H.answer = {
        ...
        init: function() {
            ...
            H.utils.resize();
            getResult('api/question/round', {
                yoi: openid
            }, 'callbackQuestionRoundHandler', true, null, true);
        ...
        fill: function(data, r) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                t._('<li data-qcode="' + qcode + '" data-ruid="' + ruid + '" data-stime="' + timestamp(qitems[i].qst) + '" data-etime="' + timestamp(qitems[i].qet) + '" id="question-' + qitems[i].quid + '" data-quid="' + qitems[i].quid + '">')._('<dl>')._('<img src="./images/talk-qus-logo.png" class="guess-answer-pic"/>')._('<dt>' + qitems[i].qt + '</dt>');
        ...
        event: function() {
            ...
            $(".goque").on("click", function() {
                $("header").css("display", "block");
                $("body").append("<section class='modal-pop'></section>");
            });
            ...
            $('#ranking').click(function(e) {
                e.preventDefault();
                $('#ranking').css({
                    "-webkit-animation": "toggle 0.4s",
                    "animation-timing-function": "linear",
                    "-webkit-animation-timing-function": "linear"
                }).on("webkitAnimationEnd", function() {
                    H.dialog.rank.open();
                    $(".rank-dialog").css({
                        "-webkit-animation": "dispshow 0.3s",
