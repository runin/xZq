			...
			tpl: function() {
				...
				t._('<section class="modal modal-guide" id="guide-dialog">')
					._('<div class="dialog guide-dialog relocated">')
						._('<div>看《下一站婚姻》微信摇一摇<h1>答题抽大奖</h1></div>')
						._('<div class="guide-content"><p>1.打开电视，锁定深圳卫视</p>')
						._('<p>2.打开微信，进入摇一摇(电视)</p>')
						._('<p>3.对着电视摇一摇</p>')
						._('<a href="#" class="btn btn-try" data-collect="true" data-collect-flag="szws-nextlove-guide-trybtn" data-collect-desc="引导弹层-关闭按钮"></a></div>')
					._('</div>')
				._('</section>');
				return t.toString();
			}
		...
		rule: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rule-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-ruledialog-closebtn" data-collect-desc="规则弹层-关闭按钮"></a>')
		...
		rank: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="rank-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-rankdialog-closebtn" data-collect-desc="积分排行榜弹层-关闭按钮"></a>')
					._('<div class="dialog rank-dialog">')
						._('<h2>积分排行榜</h2>')
						._('<p>全剧剧终累计积分冠军可获得泰国双人游<br />大礼包，二至九名可获得明星签名照套装一份</p>')
		...
		fudai: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="fudai-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-rankdialog-closebtn" data-collect-desc="领奖弹层-关闭按钮"></a>')
					._('<div class="fudai" data-collect="true" data-collect-flag="szws-nextlove-rankdialog-clickbtn" data-collect-desc="领奖弹层-点击按钮"><p>恭喜您，答对喽<br>快点拆开看看有什么吧!</p><div class="fudai-round"></div><i>马上打开</i></div>')
				._('</section>');
				return t.toString();
			}
		},
		lottery: {
			...
			update: function(data) {
				if (data != null && data != '') {
					if (data.result) {
						if (data.pt === 1) { //实物奖品
							this.$dialog.find('.awardwin-tips').html('恭喜您获得精美礼品一份');
							this.$dialog.find('.awardwin-tips').css('margin', '35% 0 25%');
							...
							this.$dialog.find('.awardwin-tips').html('恭喜您中奖了<br>积分使用请看活动规则');
							this.$dialog.find('.awardwin-tips').css('margin', '30% 0 17%');
							this.$dialog.find('img').attr('src', (data.pi || ''));
							this.$dialog.find('.name').val(data.rn || '');
							this.$dialog.find('.mobile').val(data.ph || '');
							this.$dialog.find('.address').val(data.ad || '');
							...
							this.$dialog.find('.awardwin-tips').html('恭喜您获得红包一个');
							this.$dialog.find('.awardwin-tips').css('margin', '35% 0 25%');
							this.$dialog.find('img').attr('src', (data.pi || ''));
							this.$dialog.addClass(this.LOTTERIED_CLS);
                    	 	recordUserPage(openid, "深圳卫视《下一站婚姻》红包领奖页", '');
							this.$dialog.find('.award-win').removeClass('none');
			...
			tpl: function() {
				...
				t._('<section class="modal" id="lottery-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-lotterydialog-closebtn" data-collect-desc="抽奖弹层-关闭按钮"></a>')
					._('<div class="dialog lottery-dialog">')
						._('<div class="dialog-inner">')
							._('<div class="content">')
								._('<div class="back">')
									._('<div class="award-win none">')
										._('<h5 class="awardwin-tips">恭喜您获得精美礼品一份</h5>')
										...
										._('<div class="contact">')
											...
											._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="szws-nextlove-lotterydialog-OKbtn" data-collect-desc="抽奖弹层-确定按钮">确定</a>')
											._('<a href="#" class="btn btn-red" data-collect="true" data-collect-flag="szws-nextlove-lotterydialog-redbtn" data-collect-desc="抽奖弹层-领取现金按钮">领取现金</a>')
											._('<div class="share"><a href="#" class="btn-share">把好运气分享给小伙伴吧!</a></div>')
										._('</div>')
									._('</div>')
									._('<div class="award-none none">')
										._('<h5>很遗憾，您未抽中奖品</h5>')
										._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-lotterydialog-backbtn" data-collect-desc="抽奖弹层-返回按钮">返回答题</a>')
									._('</div>')
								._('</div>')
							._('</div>')
						._('</div>')
		...
		success: {
			...
			tpl: function() {
				...
				t._('<section class="modal" id="success-dialog">')
					._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="szws-nextlove-successdialog-closebtn" data-collect-desc="领奖成功弹层-关闭按钮"></a>')
					._('<div class="success" data-collect="true" data-collect-flag="szws-nextlove-successdialog-clickbtn" data-collect-desc="领奖成功弹层-点击按钮"><div class="success-round"></div><p>领取成功</p><i>关注微店公众号</i></div>')
