                            ...
                            ._('<div class="content">')
                                ._('<div class="back">')
                                    ...
                                    ._('<div class="award-win none">')
                                        ._('<img class="pi" src="" />')
                                        ._('<div class="contact">')
                                            ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="lotterydialog-combtn" data-collect-desc="抽奖弹层-抽奖确认按钮">提 交</a>')
                                        ._('</div>')
                                    ._('</div>')
                    ...
                    ._('<div class="dialog lottery-dialog jf-dialog wllottery-dialog">')
                        ._('<div class="dialog-inner">')
                            ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="yao-wldialog-closebtn" data-collect-desc="外链抽奖弹层-关闭按钮"></a>')
                                ._('<img class="jf-top" src="images/quan-top.png" />')
                                ._('<div class="award-card none">')
                                    ._('<h3 class="tt"></h3>')
                                    ._('<img class="pi" src="" />')
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<div class="dialog thanks-dialog">')
                        ...
                        ._('<h2>在衡水老白干官方微信回复“我要答案”<br/> 即可获得您想要的正确答案，<br/> 一般人我不告诉他！</h2>')
                    ._('</div>')
                ._('</section>');
                return t.toString();
            }
            ...
            tpl: function() {
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<div class="dialog thanks-dialog">')
                        ...
                        ._('<h2>长按图片识别二维码 <br/>关注衡水老白干官方账号</h2>')
                    ._('</div>')
                ._('</section>');
                return t.toString();
            },
