    ...
    H.yao = {
        ...
        count_down : function() {
            $('.detail-countdown').each(function() {
                var me = H.yao;
                $(this).countDown({
                    etpl : '<span class="c-bg">' + '%H%' + '</span><label class="dian"><img src="images/dian.png" /></label><span class="c-bg">' + '%M%' + '</span><label class="dian"><img src="images/dian.png" /></label><span class="c-bg">' + '%S%'+'</span>', // 还有...结束
                    stpl : '<span class="c-bg">' + '%H%' + '</span><label class="dian"><img src="images/dian.png" /></label><span class="c-bg">' + '%M%' + '</span><label class="dian"><img src="images/dian.png" /></label><span class="c-bg">' + '%S%'+'</span>', // 还有...开始
                    sdtpl : '',
                    otpl : '',
                    otCallback : function() {
