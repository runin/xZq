...
var share_info = function(share_type){
	if(share_type == 1){//求帮忙开红包
		share_img = share_Rimg;
		share_title = share_Rtitle;
		share_desc = share_Rdesc;
		share_group = share_Rgroup;
	}else if(share_type == 2){//红包全部打开
		share_img = share_Rimg_wan;
		share_title = share_Rtitle_wan;
		share_desc = share_Rdesc_wan;
		share_group = share_Rgroup_wan;
	}
};
