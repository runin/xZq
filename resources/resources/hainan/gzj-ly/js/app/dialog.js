            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="lottery-dialog">')
                    ._('<div class="dialog lottery-dialog">')
                        ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="gzj-yao-lotterydialog-closebtn" data-collect-desc="卡劵抽奖弹层-关闭按钮"></a>')
                        ._('<div class="dialog-inner">')
                            ._('<div class="award-win none">')
                                ._('<img class="gx" src="images/gx.png">')
                                ._('<h2 class="tt"></h2>')
                                ._('<img class="pi" src="" />')
                                ._('<div class="contact">')
                                    ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="gzj-yao-lotterydialog-combtn" data-collect-desc="卡劵抽奖弹层-抽奖确认按钮">领 取</a>')
                                ._('</div>')
                            ._('</div>')
                        ._('</div>')
                    ._('</div>')
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="lottery-dialog">')
                    ._('<div class="dialog lottery-dialog sw-dialog">')
                            ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="gzj-yao-swdialog-closebtn" data-collect-desc="实物抽奖弹层-关闭按钮"></a>')
                            ._('<div class="award-win none">')
                                ._('<img class="gx" src="images/gx.png">')
                                ._('<h2 class="tt"></h2>')
                                ._('<img class="pi" src="" />')
                                ._('<div class="contact">')
                                    ._('<h4 class="award-tip">请输入您的联系方式</h4>')
                                    ._('<p><label>姓名:</label><input type="text" class="name"/></p>')
                                    ._('<p><label>电话:</label><input type="tel" class="mobile" /></p>')
                                    ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="gzj-yao-swdialog-combtn" data-collect-desc="实物抽奖弹层-抽奖确认按钮">提 交</a>')
                                    ._('<a href="#" class="btn btn-share btn-qd" data-collect="true" data-collect-flag="gzj-yao-swdialog-back-btn" data-collect-desc="实物抽奖弹层-返回按钮">返 回</a>')
                                ._('</div>')
                            ._('</div>')
                    ._('</div>')
                ._('</section>');
        ...
        redLottery: {
            ...
            tpl: function() {
                ...
                t._('<section class="modal" id="red-dialog">')
                    ...
                    ._('<a href="#" class="btn-close" data-collect="true" data-collect-flag="gzj-yao-reddialog-closebtn" data-collect-desc="红包抽奖弹层-关闭按钮"></a>')
                        ._('<div class="award-card none">')
                            ._('<img class="gx" src="images/gx.png">')
                            //._('<h2 class="tt"></h2>')
                            ._('<img class="pi" src="" />')
                            ._('<a href="#" class="btn btn-award" data-collect="true" data-collect-flag="gzj-yao-reddialog-btn-award" data-collect-desc="红包抽奖弹层-领取按钮">领 取</a>')
                        ._('</div>')
                    ._('</div>')
                ._('</section>');
