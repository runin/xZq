                ...
                t._('<section class="modal modal-shiwu" id="shiwu-dialog">')
                    ._('<section class="dialog shiwu-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            ...
                            ._('</section>')
                            ._('<section class="btn-lottery-box">')
                                ._('<a href="javascript:void(0);" class="btn-lottery btn-wxcard-lottery-award" id="btn-shiwuLottery-award" data-collect="true" data-collect-flag="dialog-btn-shiwuLottery-award" data-collect-desc="弹层(实物)-领取按钮">立即领取</a>')
                            ._('</section>')
                        ._('</div>')
                    ._('</section>')
                ._('</section>');
                ...
                t._('<section class="modal modal-thanks" id="thanks-dialog">')
                    ._('<section class="dialog thanks-dialog">')
                        ...
                        ._('<div class="dialog-content">')
                            ...
                            ._('<img class="icon-thanks" src="images/code.jpg">')
                            ._('<h3 class="tlt">关注“武林风”官方公证号，<br/>赢取更多好礼</h3>')
                        ._('</div>')
                        ._('<section class="btn-lottery-box">')
                            ._('<a href="javascript:void(0);" class="btn-lottery" id="btn-thanksLottery-close" data-collect="true" data-collect-flag="dialog-thanksLottery-award" data-collect-desc="弹层(谢谢参与)-关闭取按钮"></a>')
                        ._('</section>')
                    ._('</section>')
                ._('</section>');
                return t.toString();
